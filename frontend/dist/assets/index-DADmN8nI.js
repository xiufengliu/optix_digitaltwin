 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,K){var U=D.length;D.push(K);e:for(;0<U;){var te=U-1>>>1,ue=D[te];if(0<r(ue,K))D[te]=K,D[U]=ue,U=te;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var K=D[0],U=D.pop();if(U!==K){D[0]=U;e:for(var te=0,ue=D.length,we=ue>>>1;te<we;){var Y=2*(te+1)-1,ie=D[Y],he=Y+1,se=D[he];if(0>r(ie,U))he<ue&&0>r(se,ie)?(D[te]=se,D[he]=U,te=he):(D[te]=ie,D[Y]=U,te=Y);else if(he<ue&&0>r(se,U))D[te]=se,D[he]=U,te=he;else break e}}return K}function r(D,K){var U=D.sortIndex-K.sortIndex;return U!==0?U:D.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,f=null,h=3,p=!1,g=!1,S=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate!="undefined"?setImmediate:null;typeof navigator!="undefined"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(D){for(var K=n(c);K!==null;){if(K.callback===null)i(c);else if(K.startTime<=D)i(c),K.sortIndex=K.expirationTime,e(l,K);else break;K=n(c)}}function y(D){if(S=!1,v(D),!g)if(n(l)!==null)g=!0,X(P);else{var K=n(c);K!==null&&ee(y,K.startTime-D)}}function P(D,K){g=!1,S&&(S=!1,u(R),R=-1),p=!0;var U=h;try{for(v(K),f=n(l);f!==null&&(!(f.expirationTime>K)||D&&!L());){var te=f.callback;if(typeof te=="function"){f.callback=null,h=f.priorityLevel;var ue=te(f.expirationTime<=K);K=t.unstable_now(),typeof ue=="function"?f.callback=ue:f===n(l)&&i(l),v(K)}else i(l);f=n(l)}if(f!==null)var we=!0;else{var Y=n(c);Y!==null&&ee(y,Y.startTime-K),we=!1}return we}finally{f=null,h=U,p=!1}}var C=!1,b=null,R=-1,T=5,w=-1;function L(){return!(t.unstable_now()-w<T)}function z(){if(b!==null){var D=t.unstable_now();w=D;var K=!0;try{K=b(!0,D)}finally{K?F():(C=!1,b=null)}}else C=!1}var F;if(typeof _=="function")F=function(){_(z)};else if(typeof MessageChannel!="undefined"){var j=new MessageChannel,Z=j.port2;j.port1.onmessage=z,F=function(){Z.postMessage(null)}}else F=function(){m(z,0)};function X(D){b=D,C||(C=!0,F())}function ee(D,K){R=m(function(){D(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,X(P))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(h){case 1:case 2:case 3:var K=3;break;default:K=h}var U=h;h=K;try{return D()}finally{h=U}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,K){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var U=h;h=D;try{return K()}finally{h=U}},t.unstable_scheduleCallback=function(D,K,U){var te=t.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?te+U:te):U=te,D){case 1:var ue=-1;break;case 2:ue=250;break;case 5:ue=1073741823;break;case 4:ue=1e4;break;default:ue=5e3}return ue=U+ue,D={id:d++,callback:K,priorityLevel:D,startTime:U,expirationTime:ue,sortIndex:-1},U>te?(D.sortIndex=U,e(c,D),n(l)===null&&D===n(c)&&(S?(u(R),R=-1):S=!0,ee(y,U-te))):(D.sortIndex=ue,e(l,D),g||p||(g=!0,X(P))),D},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(D){var K=h;return function(){var U=h;h=K;try{return D.apply(this,arguments)}finally{h=U}}}})(yg);vg.exports=yg;var Lv=vg.exports;/**
 * @license React
...
`)+`
`+u);const v=_+m+o,y=_+u+a,P=bm(r,r.VERTEX_SHADER,v),C=bm(r,r.FRAGMENT_SHADER,y);r.attachShader(S,P),r.attachShader(S,C),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function b(L){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(S).trim(),F=r.getShaderInfoLog(P).trim(),j=r.getShaderInfoLog(C).trim();let Z=!0,X=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(Z=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,P,C);else{const ee=Rm(r,P,"vertex"),D=Rm(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+ee+`
`+D)}else z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",z):(F===""||j==="")&&(X=!1);X&&(L.diagnostics={runnable:Z,programLog:z,vertexShader:{log:F,prefix:m},fragmentShader:{log:j,prefix:u}})}r.deleteShader(P),r.deleteShader(C),R=new Rl(r,S),T=Q1(r,S)}let R;this.getUniforms=function(){return R===void 0&&b(this),R};let T;this.getAttributes=function(){return T===void 0&&b(this),T};let w=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=r.getProgramParameter(S,W1)),w},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(S),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=j1++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=P,this.fragmentShader=C,this}let dT=0;class hT{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new fT(e),n.set(e,i)),i}}class fT{constructor(e){this.id=dT++,this.code=e,this.usedTimes=0}}function pT(t,e,n,i,r,s,o){const a=new Sf,l=new hT,c=new Set,d=[],f=r.logarithmicDepthBuffer,h=r.vertexTextures;let p=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function S(T){return c.add(T),T===0?"uv":`uv${T}`}function m(T,w,L,z,F){const j=z.fog,Z=F.geometry,X=T.isMeshStandardMaterial?z.environment:null,ee=(T.isMeshStandardMaterial?n:e).get(T.envMap||X),D=ee&&ee.mapping===Ec?ee.image.height:null,K=g[T.type];T.precision!==null&&(p=r.getMaxPrecision(T.precision),p!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",p,"instead."));const U=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,te=U!==void 0?U.length:0;let ue=0;Z.morphAttributes.position!==void 0&&(ue=1),Z.morphAttributes.normal!==void 0&&(ue=2),Z.morphAttributes.color!==void 0&&(ue=3);let we,Y,ie,he;if(K){const et=ti[K];we=et.vertexShader,Y=et.fragmentShader}else we=T.vertexShader,Y=T.fragmentShader,l.update(T),ie=l.getVertexShaderID(T),he=l.getFragmentShaderID(T);const se=t.getRenderTarget(),Le=t.state.buffers.depth.getReversed(),Ne=F.isInstancedMesh===!0,Be=F.isBatchedMesh===!0,Xe=!!T.map,Oe=!!T.matcap,pt=!!ee,B=!!T.aoMap,Rt=!!T.lightMap,Ue=!!T.bumpMap,Ge=!!T.normalMap,O=!!T.displacementMap,W=!!T.emissiveMap,G=!!T.metalnessMap,E=!!T.roughnessMap,x=T.anisotropy>0,I=T.clearcoat>0,Q=T.dispersion>0,re=T.iridescence>0,ne=T.sheen>0,Te=T.transmission>0,me=x&&!!T.anisotropyMap,Se=I&&!!T.clearcoatMap,Ke=I&&!!T.clearcoatNormalMap,ce=I&&!!T.clearcoatRoughnessMap,_e=re&&!!T.iridescenceMap,Ae=re&&!!T.iridescenceThicknessMap,Ie=ne&&!!T.sheenColorMap,Ee=ne&&!!T.sheenRoughnessMap,qe=!!T.specularMap,ke=!!T.specularColorMap,tt=!!T.specularIntensityMap,k=Te&&!!T.transmissionMap,fe=Te&&!!T.thicknessMap,J=!!T.gradientMap,oe=!!T.alphaMap,ve=T.alphaTest>0,ge=!!T.alphaHash,ze=!!T.extensions;let yt=rr;T.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(yt=t.toneMapping);const Ft={shaderID:K,shaderType:T.type,shaderName:T.name,vertexShader:we,fragmentShader:Y,defines:T.defines,customVertexShaderID:ie,customFragmentShaderID:he,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:p,batching:Be,batchingColor:Be&&F._colorsTexture!==null,instancing:Ne,instancingColor:Ne&&F.instanceColor!==null,instancingMorph:Ne&&F.morphTexture!==null,supportsVertexTextures:h,outputColorSpace:se===null?t.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:Js,alphaToCoverage:!!T.alphaToCoverage,map:Xe,matcap:Oe,envMap:pt,envMapMode:pt&&ee.mapping,envMapCubeUVHeight:D,aoMap:B,lightMap:Rt,bumpMap:Ue,normalMap:Ge,displacementMap:h&&O,emissiveMap:W,normalMapObjectSpace:Ge&&T.normalMapType===SS,normalMapTangentSpace:Ge&&T.normalMapType===L0,metalnessMap:G,roughnessMap:E,anisotropy:x,anisotropyMap:me,clearcoat:I,clearcoatMap:Se,clearcoatNormalMap:Ke,clearcoatRoughnessMap:ce,dispersion:Q,iridescence:re,iridescenceMap:_e,iridescenceThicknessMap:Ae,sheen:ne,sheenColorMap:Ie,sheenRoughnessMap:Ee,specularMap:qe,specularColorMap:ke,specularIntensityMap:tt,transmission:Te,transmissionMap:k,thicknessMap:fe,gradientMap:J,opaque:T.transparent===!1&&T.blending===Ns&&T.alphaToCoverage===!1,alphaMap:oe,alphaTest:ve,alphaHash:ge,combine:T.combine,mapUv:Xe&&S(T.map.channel),aoMapUv:B&&S(T.aoMap.channel),lightMapUv:Rt&&S(T.lightMap.channel),bumpMapUv:Ue&&S(T.bumpMap.channel),normalMapUv:Ge&&S(T.normalMap.channel),displacementMapUv:O&&S(T.displacementMap.channel),emissiveMapUv:W&&S(T.emissiveMap.channel),metalnessMapUv:G&&S(T.metalnessMap.channel),roughnessMapUv:E&&S(T.roughnessMap.channel),anisotropyMapUv:me&&S(T.anisotropyMap.channel),clearcoatMapUv:Se&&S(T.clearcoatMap.channel),clearcoatNormalMapUv:Ke&&S(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ce&&S(T.clearcoatRoughnessMap.channel),iridescenceMapUv:_e&&S(T.iridescenceMap.channel),iridescenceThicknessMapUv:Ae&&S(T.iridescenceThicknessMap.channel),sheenColorMapUv:Ie&&S(T.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&S(T.sheenRoughnessMap.channel),specularMapUv:qe&&S(T.specularMap.channel),specularColorMapUv:ke&&S(T.specularColorMap.channel),specularIntensityMapUv:tt&&S(T.specularIntensityMap.channel),transmissionMapUv:k&&S(T.transmissionMap.channel),thicknessMapUv:fe&&S(T.thicknessMap.channel),alphaMapUv:oe&&S(T.alphaMap.channel),vertexTangents:!!Z.attributes.tangent&&(Ge||x),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!Z.attributes.uv&&(Xe||oe),fog:!!j,useFog:T.fog===!0,fogExp2:!!j&&j.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:f,reverseDepthBuffer:Le,skinning:F.isSkinnedMesh===!0,morphTargets:Z.morphAttributes.position!==void 0,morphNormals:Z.morphAttributes.normal!==void 0,morphColors:Z.morphAttributes.color!==void 0,morphTargetsCount:te,morphTextureStride:ue,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:T.dithering,shadowMapEnabled:t.shadowMap.enabled&&L.length>0,shadowMapType:t.shadowMap.type,toneMapping:yt,decodeVideoTexture:Xe&&T.map.isVideoTexture===!0&&Ze.getTransfer(T.map.colorSpace)===ot,decodeVideoTextureEmissive:W&&T.emissiveMap.isVideoTexture===!0&&Ze.getTransfer(T.emissiveMap.colorSpace)===ot,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===vi,flipSided:T.side===pn,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:ze&&T.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ze&&T.extensions.multiDraw===!0||Be)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return Ft.vertexUv1s=c.has(1),Ft.vertexUv2s=c.has(2),Ft.vertexUv3s=c.has(3),c.clear(),Ft}function u(T){const w=[];if(T.shaderID?w.push(T.shaderID):(w.push(T.customVertexShaderID),w.push(T.customFragmentShaderID)),T.defines!==void 0)for(const L in T.defines)w.push(L),w.push(T.defines[L]);return T.isRawShaderMaterial===!1&&(_(w,T),v(w,T),w.push(t.outputColorSpace)),w.push(T.customProgramCacheKey),w.join()}function _(T,w){T.push(w.precision),T.push(w.outputColorSpace),T.push(w.envMapMode),T.push(w.envMapCubeUVHeight),T.push(w.mapUv),T.push(w.alphaMapUv),T.push(w.lightMapUv),T.push(w.aoMapUv),T.push(w.bumpMapUv),T.push(w.normalMapUv),T.push(w.displacementMapUv),T.push(w.emissiveMapUv),T.push(w.metalnessMapUv),T.push(w.roughnessMapUv),T.push(w.anisotropyMapUv),T.push(w.clearcoatMapUv),T.push(w.clearcoatNormalMapUv),T.push(w.clearcoatRoughnessMapUv),T.push(w.iridescenceMapUv),T.push(w.iridescenceThicknessMapUv),T.push(w.sheenColorMapUv),T.push(w.sheenRoughnessMapUv),T.push(w.specularMapUv),T.push(w.specularColorMapUv),T.push(w.specularIntensityMapUv),T.push(w.transmissionMapUv),T.push(w.thicknessMapUv),T.push(w.combine),T.push(w.fogExp2),T.push(w.sizeAttenuation),T.push(w.morphTargetsCount),T.push(w.morphAttributeCount),T.push(w.numDirLights),T.push(w.numPointLights),T.push(w.numSpotLights),T.push(w.numSpotLightMaps),T.push(w.numHemiLights),T.push(w.numRectAreaLights),T.push(w.numDirLightShadows),T.push(w.numPointLightShadows),T.push(w.numSpotLightShadows),T.push(w.numSpotLightShadowsWithMaps),T.push(w.numLightProbes),T.push(w.shadowMapType),T.push(w.toneMapping),T.push(w.numClippingPlanes),T.push(w.numClipIntersection),T.push(w.depthPacking)}function v(T,w){a.disableAll(),w.supportsVertexTextures&&a.enable(0),w.instancing&&a.enable(1),w.instancingColor&&a.enable(2),w.instancingMorph&&a.enable(3),w.matcap&&a.enable(4),w.envMap&&a.enable(5),w.normalMapObjectSpace&&a.enable(6),w.normalMapTangentSpace&&a.enable(7),w.clearcoat&&a.enable(8),w.iridescence&&a.enable(9),w.alphaTest&&a.enable(10),w.vertexColors&&a.enable(11),w.vertexAlphas&&a.enable(12),w.vertexUv1s&&a.enable(13),w.vertexUv2s&&a.enable(14),w.vertexUv3s&&a.enable(15),w.vertexTangents&&a.enable(16),w.anisotropy&&a.enable(17),w.alphaHash&&a.enable(18),w.batching&&a.enable(19),w.dispersion&&a.enable(20),w.batchingColor&&a.enable(21),T.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reverseDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),T.push(a.mask)}function y(T){const w=g[T.type];let L;if(w){const z=ti[w];L=ZS.clone(z.uniforms)}else L=T.uniforms;return L}function P(T,w){let L;for(let z=0,F=d.length;z<F;z++){const j=d[z];if(j.cacheKey===w){L=j,++L.usedTimes;break}}return L===void 0&&(L=new uT(t,w,T,s),d.push(L)),L}function C(T){if(--T.usedTimes===0){const w=d.indexOf(T);d[w]=d[d.length-1],d.pop(),T.destroy()}}function b(T){l.remove(T)}function R(){l.dispose()}return{getParameters:m,getProgramCacheKey:u,getUniforms:y,acquireProgram:P,releaseProgram:C,releaseShaderCache:b,programs:d,dispose:R}}function mT(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function gT(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function Im(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function Um(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(f,h,p,g,S,m){let u=t[e];return u===void 0?(u={id:f.id,object:f,geometry:h,material:p,groupOrder:g,renderOrder:f.renderOrder,z:S,group:m},t[e]=u):(u.id=f.id,u.object=f,u.geometry=h,u.material=p,u.groupOrder=g,u.renderOrder=f.renderOrder,u.z=S,u.group=m),e++,u}function a(f,h,p,g,S,m){const u=o(f,h,p,g,S,m);p.transmission>0?i.push(u):p.transparent===!0?r.push(u):n.push(u)}function l(f,h,p,g,S,m){const u=o(f,h,p,g,S,m);p.transmission>0?i.unshift(u):p.transparent===!0?r.unshift(u):n.unshift(u)}function c(f,h){n.length>1&&n.sort(f||gT),i.length>1&&i.sort(h||Im),r.length>1&&r.sort(h||Im)}function d(){for(let f=e,h=t.length;f<h;f++){const p=t[f];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:d,sort:c}}function _T(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new Um,t.set(i,[o])):r>=s.length?(o=new Um,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function vT(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new N,color:new Ye};break;case"SpotLight":n={position:new N,direction:new N,color:new Ye,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new N,color:new Ye,distance:0,decay:0};break;case"HemisphereLight":n={direction:new N,skyColor:new Ye,groundColor:new Ye};break;case"RectAreaLight":n={color:new Ye,position:new N,halfWidth:new N,halfHeight:new N};break}return t[e.id]=n,n}}}function yT(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let xT=0;function ST(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function MT(t){const e=new vT,n=yT(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new N);const r=new N,s=new ct,o=new ct;function a(c){let d=0,f=0,h=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let p=0,g=0,S=0,m=0,u=0,_=0,v=0,y=0,P=0,C=0,b=0;c.sort(ST);for(let T=0,w=c.length;T<w;T++){const L=c[T],z=L.color,F=L.intensity,j=L.distance,Z=L.shadow&&L.shadow.map?L.shadow.map.texture:null;if(L.isAmbientLight)d+=z.r*F,f+=z.g*F,h+=z.b*F;else if(L.isLightProbe){for(let X=0;X<9;X++)i.probe[X].addScaledVector(L.sh.coefficients[X],F);b++}else if(L.isDirectionalLight){const X=e.get(L);if(X.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const ee=L.shadow,D=n.get(L);D.shadowIntensity=ee.intensity,D.shadowBias=ee.bias,D.shadowNormalBias=ee.normalBias,D.shadowRadius=ee.radius,D.shadowMapSize=ee.mapSize,i.directionalShadow[p]=D,i.directionalShadowMap[p]=Z,i.directionalShadowMatrix[p]=L.shadow.matrix,_++}i.directional[p]=X,p++}else if(L.isSpotLight){const X=e.get(L);X.position.setFromMatrixPosition(L.matrixWorld),X.color.copy(z).multiplyScalar(F),X.distance=j,X.coneCos=Math.cos(L.angle),X.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),X.decay=L.decay,i.spot[S]=X;const ee=L.shadow;if(L.map&&(i.spotLightMap[P]=L.map,P++,ee.updateMatrices(L),L.castShadow&&C++),i.spotLightMatrix[S]=ee.matrix,L.castShadow){const D=n.get(L);D.shadowIntensity=ee.intensity,D.shadowBias=ee.bias,D.shadowNormalBias=ee.normalBias,D.shadowRadius=ee.radius,D.shadowMapSize=ee.mapSize,i.spotShadow[S]=D,i.spotShadowMap[S]=Z,y++}S++}else if(L.isRectAreaLight){const X=e.get(L);X.color.copy(z).multiplyScalar(F),X.halfWidth.set(L.width*.5,0,0),X.halfHeight.set(0,L.height*.5,0),i.rectArea[m]=X,m++}else if(L.isPointLight){const X=e.get(L);if(X.color.copy(L.color).multiplyScalar(L.intensity),X.distance=L.distance,X.decay=L.decay,L.castShadow){const ee=L.shadow,D=n.get(L);D.shadowIntensity=ee.intensity,D.shadowBias=ee.bias,D.shadowNormalBias=ee.normalBias,D.shadowRadius=ee.radius,D.shadowMapSize=ee.mapSize,D.shadowCameraNear=ee.camera.near,D.shadowCameraFar=ee.camera.far,i.pointShadow[g]=D,i.pointShadowMap[g]=Z,i.pointShadowMatrix[g]=L.shadow.matrix,v++}i.point[g]=X,g++}else if(L.isHemisphereLight){const X=e.get(L);X.skyColor.copy(L.color).multiplyScalar(F),X.groundColor.copy(L.groundColor).multiplyScalar(F),i.hemi[u]=X,u++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=pe.LTC_FLOAT_1,i.rectAreaLTC2=pe.LTC_FLOAT_2):(i.rectAreaLTC1=pe.LTC_HALF_1,i.rectAreaLTC2=pe.LTC_HALF_2)),i.ambient[0]=d,i.ambient[1]=f,i.ambient[2]=h;const R=i.hash;(R.directionalLength!==p||R.pointLength!==g||R.spotLength!==S||R.rectAreaLength!==m||R.hemiLength!==u||R.numDirectionalShadows!==_||R.numPointShadows!==v||R.numSpotShadows!==y||R.numSpotMaps!==P||R.numLightProbes!==b)&&(i.directional.length=p,i.spot.length=S,i.rectArea.length=m,i.point.length=g,i.hemi.length=u,i.directionalShadow.length=_,i.directionalShadowMap.length=_,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=_,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=y+P-C,i.spotLightMap.length=P,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=b,R.directionalLength=p,R.pointLength=g,R.spotLength=S,R.rectAreaLength=m,R.hemiLength=u,R.numDirectionalShadows=_,R.numPointShadows=v,R.numSpotShadows=y,R.numSpotMaps=P,R.numLightProbes=b,i.version=xT++)}function l(c,d){let f=0,h=0,p=0,g=0,S=0;const m=d.matrixWorldInverse;for(let u=0,_=c.length;u<_;u++){const v=c[u];if(v.isDirectionalLight){const y=i.directional[f];y.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),f++}else if(v.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(v.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),p++}else if(v.isRectAreaLight){const y=i.rectArea[g];y.position.setFromMatrixPosition(v.matrixWorld),y.position.applyMatrix4(m),o.identity(),s.copy(v.matrixWorld),s.premultiply(m),o.extractRotation(s),y.halfWidth.set(v.width*.5,0,0),y.halfHeight.set(0,v.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),g++}else if(v.isPointLight){const y=i.point[h];y.position.setFromMatrixPosition(v.matrixWorld),y.position.applyMatrix4(m),h++}else if(v.isHemisphereLight){const y=i.hemi[S];y.direction.setFromMatrixPosition(v.matrixWorld),y.direction.transformDirection(m),S++}}}return{setup:a,setupView:l,state:i}}function Fm(t){const e=new MT(t),n=[],i=[];function r(d){c.camera=d,n.length=0,i.length=0}function s(d){n.push(d)}function o(d){i.push(d)}function a(){e.setup(n)}function l(d){e.setupView(n,d)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function ET(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Fm(t),e.set(r,[a])):s>=o.length?(a=new Fm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}class wT extends fr{static get type(){return"MeshDepthMaterial"}constructor(e){super(),this.isMeshDepthMaterial=!0,this.depthPacking=yS,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class TT extends fr{static get type(){return"MeshDistanceMaterial"}constructor(e){super(),this.isMeshDistanceMaterial=!0,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const AT=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function CT(t,e,n){let i=new Mf;const r=new xe,s=new xe,o=new Tt,a=new wT({depthPacking:xS}),l=new TT,c={},d=n.maxTextureSize,f={[lr]:pn,[pn]:lr,[vi]:vi},h=new cr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new xe},radius:{value:4}},vertexShader:AT,fragmentShader:bT}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const g=new Wt;g.setAttribute("position",new Un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new De(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=v0;let u=this.type;this.render=function(C,b,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const T=t.getRenderTarget(),w=t.getActiveCubeFace(),L=t.getActiveMipmapLevel(),z=t.state;z.setBlending(ir),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const F=u!==pi&&this.type===pi,j=u===pi&&this.type!==pi;for(let Z=0,X=C.length;Z<X;Z++){const ee=C[Z],D=ee.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",ee,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const K=D.getFrameExtents();if(r.multiply(K),s.copy(D.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/K.x),r.x=s.x*K.x,D.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/K.y),r.y=s.y*K.y,D.mapSize.y=s.y)),D.map===null||F===!0||j===!0){const te=this.type!==pi?{minFilter:qn,magFilter:qn}:{};D.map!==null&&D.map.dispose(),D.map=new kr(r.x,r.y,te),D.map.texture.name=ee.name+".shadowMap",D.camera.updateProjectionMatrix()}t.setRenderTarget(D.map),t.clear();const U=D.getViewportCount();for(let te=0;te<U;te++){const ue=D.getViewport(te);o.set(s.x*ue.x,s.y*ue.y,s.x*ue.z,s.y*ue.w),z.viewport(o),D.updateMatrices(ee,te),i=D.getFrustum(),y(b,R,D.camera,ee,this.type)}D.isPointLightShadow!==!0&&this.type===pi&&_(D,R),D.needsUpdate=!1}u=this.type,m.needsUpdate=!1,t.setRenderTarget(T,w,L)};function _(C,b){const R=e.update(S);h.defines.VSM_SAMPLES!==C.blurSamples&&(h.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new kr(r.x,r.y)),h.uniforms.shadow_pass.value=C.map.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(b,null,R,h,S,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(b,null,R,p,S,null)}function v(C,b,R,T){let w=null;const L=R.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(L!==void 0)w=L;else if(w=R.isPointLight===!0?l:a,t.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const z=w.uuid,F=b.uuid;let j=c[z];j===void 0&&(j={},c[z]=j);let Z=j[F];Z===void 0&&(Z=w.clone(),j[F]=Z,b.addEventListener("dispose",P)),w=Z}if(w.visible=b.visible,w.wireframe=b.wireframe,T===pi?w.side=b.shadowSide!==null?b.shadowSide:b.side:w.side=b.shadowSide!==null?b.shadowSide:f[b.side],w.alphaMap=b.alphaMap,w.alphaTest=b.alphaTest,w.map=b.map,w.clipShadows=b.clipShadows,w.clippingPlanes=b.clippingPlanes,w.clipIntersection=b.clipIntersection,w.displacementMap=b.displacementMap,w.displacementScale=b.displacementScale,w.displacementBias=b.displacementBias,w.wireframeLinewidth=b.wireframeLinewidth,w.linewidth=b.linewidth,R.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const z=t.properties.get(w);z.light=R}return w}function y(C,b,R,T,w){if(C.visible===!1)return;if(C.layers.test(b.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&w===pi)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,C.matrixWorld);const F=e.update(C),j=C.material;if(Array.isArray(j)){const Z=F.groups;for(let X=0,ee=Z.length;X<ee;X++){const D=Z[X],K=j[D.materialIndex];if(K&&K.visible){const U=v(C,K,T,w);C.onBeforeShadow(t,C,b,R,F,U,D),t.renderBufferDirect(R,null,F,U,C,D),C.onAfterShadow(t,C,b,R,F,U,D)}}}else if(j.visible){const Z=v(C,j,T,w);C.onBeforeShadow(t,C,b,R,F,Z,null),t.renderBufferDirect(R,null,F,Z,C,null),C.onAfterShadow(t,C,b,R,F,Z,null)}}const z=C.children;for(let F=0,j=z.length;F<j;F++)y(z[F],b,R,T,w)}function P(C){C.target.removeEventListener("dispose",P);for(const R in c){const T=c[R],w=C.target.uuid;w in T&&(T[w].dispose(),delete T[w])}}}const RT={[Ld]:Dd,[Nd]:Fd,[Id]:Od,[Gs]:Ud,[Dd]:Ld,[Fd]:Nd,[Od]:Id,[Ud]:Gs};function PT(t,e){function n(){let k=!1;const fe=new Tt;let J=null;const oe=new Tt(0,0,0,0);return{setMask:function(ve){J!==ve&&!k&&(t.colorMask(ve,ve,ve,ve),J=ve)},setLocked:function(ve){k=ve},setClear:function(ve,ge,ze,yt,Ft){Ft===!0&&(ve*=yt,ge*=yt,ze*=yt),fe.set(ve,ge,ze,yt),oe.equals(fe)===!1&&(t.clearColor(ve,ge,ze,yt),oe.copy(fe))},reset:function(){k=!1,J=null,oe.set(-1,0,0,0)}}}function i(){let k=!1,fe=!1,J=null,oe=null,ve=null;return{setReversed:function(ge){if(fe!==ge){const ze=e.get("EXT_clip_control");fe?ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.ZERO_TO_ONE_EXT):ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.NEGATIVE_ONE_TO_ONE_EXT);const yt=ve;ve=null,this.setClear(yt)}fe=ge},getReversed:function(){return fe},setTest:function(ge){ge?se(t.DEPTH_TEST):Le(t.DEPTH_TEST)},setMask:function(ge){J!==ge&&!k&&(t.depthMask(ge),J=ge)},setFunc:function(ge){if(fe&&(ge=RT[ge]),oe!==ge){switch(ge){case Ld:t.depthFunc(t.NEVER);break;case Dd:t.depthFunc(t.ALWAYS);break;case Nd:t.depthFunc(t.LESS);break;case Gs:t.depthFunc(t.LEQUAL);break;case Id:t.depthFunc(t.EQUAL);break;case Ud:t.depthFunc(t.GEQUAL);break;case Fd:t.depthFunc(t.GREATER);break;case Od:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}oe=ge}},setLocked:function(ge){k=ge},setClear:function(ge){ve!==ge&&(fe&&(ge=1-ge),t.clearDepth(ge),ve=ge)},reset:function(){k=!1,J=null,oe=null,ve=null,fe=!1}}}function r(){let k=!1,fe=null,J=null,oe=null,ve=null,ge=null,ze=null,yt=null,Ft=null;return{setTest:function(et){k||(et?se(t.STENCIL_TEST):Le(t.STENCIL_TEST))},setMask:function(et){fe!==et&&!k&&(t.stencilMask(et),fe=et)},setFunc:function(et,on,wn){(J!==et||oe!==on||ve!==wn)&&(t.stencilFunc(et,on,wn),J=et,oe=on,ve=wn)},setOp:function(et,on,wn){(ge!==et||ze!==on||yt!==wn)&&(t.stencilOp(et,on,wn),ge=et,ze=on,yt=wn)},setLocked:function(et){k=et},setClear:function(et){Ft!==et&&(t.clearStencil(et),Ft=et)},reset:function(){k=!1,fe=null,J=null,oe=null,ve=null,ge=null,ze=null,yt=null,Ft=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let d={},f={},h=new WeakMap,p=[],g=null,S=!1,m=null,u=null,_=null,v=null,y=null,P=null,C=null,b=new Ye(0,0,0),R=0,T=!1,w=null,L=null,z=null,F=null,j=null;const Z=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,ee=0;const D=t.getParameter(t.VERSION);D.indexOf("WebGL")!==-1?(ee=parseFloat(/^WebGL (\d)/.exec(D)[1]),X=ee>=1):D.indexOf("OpenGL ES")!==-1&&(ee=parseFloat(/^OpenGL ES (\d)/.exec(D)[1]),X=ee>=2);let K=null,U={};const te=t.getParameter(t.SCISSOR_BOX),ue=t.getParameter(t.VIEWPORT),we=new Tt().fromArray(te),Y=new Tt().fromArray(ue);function ie(k,fe,J,oe){const ve=new Uint8Array(4),ge=t.createTexture();t.bindTexture(k,ge),t.texParameteri(k,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(k,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let ze=0;ze<J;ze++)k===t.TEXTURE_3D||k===t.TEXTURE_2D_ARRAY?t.texImage3D(fe,0,t.RGBA,1,1,oe,0,t.RGBA,t.UNSIGNED_BYTE,ve):t.texImage2D(fe+ze,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ve);return ge}const he={};he[t.TEXTURE_2D]=ie(t.TEXTURE_2D,t.TEXTURE_2D,1),he[t.TEXTURE_CUBE_MAP]=ie(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[t.TEXTURE_2D_ARRAY]=ie(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),he[t.TEXTURE_3D]=ie(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(t.DEPTH_TEST),o.setFunc(Gs),Ue(!1),Ge(Vp),se(t.CULL_FACE),B(ir);function se(k){d[k]!==!0&&(t.enable(k),d[k]=!0)}function Le(k){d[k]!==!1&&(t.disable(k),d[k]=!1)}function Ne(k,fe){return f[k]!==fe?(t.bindFramebuffer(k,fe),f[k]=fe,k===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=fe),k===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=fe),!0):!1}function Be(k,fe){let J=p,oe=!1;if(k){J=h.get(fe),J===void 0&&(J=[],h.set(fe,J));const ve=k.textures;if(J.length!==ve.length||J[0]!==t.COLOR_ATTACHMENT0){for(let ge=0,ze=ve.length;ge<ze;ge++)J[ge]=t.COLOR_ATTACHMENT0+ge;J.length=ve.length,oe=!0}}else J[0]!==t.BACK&&(J[0]=t.BACK,oe=!0);oe&&t.drawBuffers(J)}function Xe(k){return g!==k?(t.useProgram(k),g=k,!0):!1}const Oe={[Er]:t.FUNC_ADD,[Xx]:t.FUNC_SUBTRACT,[Yx]:t.FUNC_REVERSE_SUBTRACT};Oe[$x]=t.MIN,Oe[qx]=t.MAX;const pt={[Kx]:t.ZERO,[Zx]:t.ONE,[Jx]:t.SRC_COLOR,[Rd]:t.SRC_ALPHA,[rS]:t.SRC_ALPHA_SATURATE,[nS]:t.DST_COLOR,[eS]:t.DST_ALPHA,[Qx]:t.ONE_MINUS_SRC_COLOR,[Pd]:t.ONE_MINUS_SRC_ALPHA,[iS]:t.ONE_MINUS_DST_COLOR,[tS]:t.ONE_MINUS_DST_ALPHA,[sS]:t.CONSTANT_COLOR,[oS]:t.ONE_MINUS_CONSTANT_COLOR,[aS]:t.CONSTANT_ALPHA,[lS]:t.ONE_MINUS_CONSTANT_ALPHA};function B(k,fe,J,oe,ve,ge,ze,yt,Ft,et){if(k===ir){S===!0&&(Le(t.BLEND),S=!1);return}if(S===!1&&(se(t.BLEND),S=!0),k!==jx){if(k!==m||et!==T){if((u!==Er||y!==Er)&&(t.blendEquation(t.FUNC_ADD),u=Er,y=Er),et)switch(k){case Ns:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Cd:t.blendFunc(t.ONE,t.ONE);break;case Gp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Wp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}else switch(k){case Ns:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Cd:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Gp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Wp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}_=null,v=null,P=null,C=null,b.set(0,0,0),R=0,m=k,T=et}return}ve=ve||fe,ge=ge||J,ze=ze||oe,(fe!==u||ve!==y)&&(t.blendEquationSeparate(Oe[fe],Oe[ve]),u=fe,y=ve),(J!==_||oe!==v||ge!==P||ze!==C)&&(t.blendFuncSeparate(pt[J],pt[oe],pt[ge],pt[ze]),_=J,v=oe,P=ge,C=ze),(yt.equals(b)===!1||Ft!==R)&&(t.blendColor(yt.r,yt.g,yt.b,Ft),b.copy(yt),R=Ft),m=k,T=!1}function Rt(k,fe){k.side===vi?Le(t.CULL_FACE):se(t.CULL_FACE);let J=k.side===pn;fe&&(J=!J),Ue(J),k.blending===Ns&&k.transparent===!1?B(ir):B(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),o.setFunc(k.depthFunc),o.setTest(k.depthTest),o.setMask(k.depthWrite),s.setMask(k.colorWrite);const oe=k.stencilWrite;a.setTest(oe),oe&&(a.setMask(k.stencilWriteMask),a.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),a.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),W(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Le(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ue(k){w!==k&&(k?t.frontFace(t.CW):t.frontFace(t.CCW),w=k)}function Ge(k){k!==Vx?(se(t.CULL_FACE),k!==L&&(k===Vp?t.cullFace(t.BACK):k===Gx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Le(t.CULL_FACE),L=k}function O(k){k!==z&&(X&&t.lineWidth(k),z=k)}function W(k,fe,J){k?(se(t.POLYGON_OFFSET_FILL),(F!==fe||j!==J)&&(t.polygonOffset(fe,J),F=fe,j=J)):Le(t.POLYGON_OFFSET_FILL)}function G(k){k?se(t.SCISSOR_TEST):Le(t.SCISSOR_TEST)}function E(k){k===void 0&&(k=t.TEXTURE0+Z-1),K!==k&&(t.activeTexture(k),K=k)}function x(k,fe,J){J===void 0&&(K===null?J=t.TEXTURE0+Z-1:J=K);let oe=U[J];oe===void 0&&(oe={type:void 0,texture:void 0},U[J]=oe),(oe.type!==k||oe.texture!==fe)&&(K!==J&&(t.activeTexture(J),K=J),t.bindTexture(k,fe||he[k]),oe.type=k,oe.texture=fe)}function I(){const k=U[K];k!==void 0&&k.type!==void 0&&(t.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function Q(){try{t.compressedTexImage2D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function re(){try{t.compressedTexImage3D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ne(){try{t.texSubImage2D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Te(){try{t.texSubImage3D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function me(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Se(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Ke(){try{t.texStorage2D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ce(){try{t.texStorage3D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function _e(){try{t.texImage2D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Ae(){try{t.texImage3D.apply(t,arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Ie(k){we.equals(k)===!1&&(t.scissor(k.x,k.y,k.z,k.w),we.copy(k))}function Ee(k){Y.equals(k)===!1&&(t.viewport(k.x,k.y,k.z,k.w),Y.copy(k))}function qe(k,fe){let J=c.get(fe);J===void 0&&(J=new WeakMap,c.set(fe,J));let oe=J.get(k);oe===void 0&&(oe=t.getUniformBlockIndex(fe,k.name),J.set(k,oe))}function ke(k,fe){const oe=c.get(fe).get(k);l.get(fe)!==oe&&(t.uniformBlockBinding(fe,oe,k.__bindingPointIndex),l.set(fe,oe))}function tt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),d={},K=null,U={},f={},h=new WeakMap,p=[],g=null,S=!1,m=null,u=null,_=null,v=null,y=null,P=null,C=null,b=new Ye(0,0,0),R=0,T=!1,w=null,L=null,z=null,F=null,j=null,we.set(0,0,t.canvas.width,t.canvas.height),Y.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:Le,bindFramebuffer:Ne,drawBuffers:Be,useProgram:Xe,setBlending:B,setMaterial:Rt,setFlipSided:Ue,setCullFace:Ge,setLineWidth:O,setPolygonOffset:W,setScissorTest:G,activeTexture:E,bindTexture:x,unbindTexture:I,compressedTexImage2D:Q,compressedTexImage3D:re,texImage2D:_e,texImage3D:Ae,updateUBOMapping:qe,uniformBlockBinding:ke,texStorage2D:Ke,texStorage3D:ce,texSubImage2D:ne,texSubImage3D:Te,compressedTexSubImage2D:me,compressedTexSubImage3D:Se,scissor:Ie,viewport:Ee,reset:tt}}function Om(t,e,n,i){const r=LT(i);switch(n){case w0:return t*e;case A0:return t*e;case b0:return t*e*2;case C0:return t*e/r.components*r.byteLength;case vf:return t*e/r.components*r.byteLength;case R0:return t*e*2/r.components*r.byteLength;case yf:return t*e*2/r.components*r.byteLength;case T0:return t*e*3/r.components*r.byteLength;case Xn:return t*e*4/r.components*r.byteLength;case xf:return t*e*4/r.components*r.byteLength;case El:case wl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Tl:case Al:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Gd:case jd:return Math.max(t,16)*Math.max(e,8)/4;case Vd:case Wd:return Math.max(t,8)*Math.max(e,8)/2;case Xd:case Yd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case $d:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case qd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Kd:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case Zd:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Jd:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Qd:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case eh:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case th:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case nh:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case ih:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case rh:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case sh:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case oh:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case ah:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case lh:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case bl:case ch:case uh:return Math.ceil(t/4)*Math.ceil(e/4)*16;case P0:case dh:return Math.ceil(t/4)*Math.ceil(e/4)*8;case hh:case fh:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function LT(t){switch(t){case Pi:case S0:return{byteLength:1,components:1};case ra:case M0:case ua:return{byteLength:2,components:1};case gf:case _f:return{byteLength:2,components:4};case Or:case mf:case Si:return{byteLength:4,components:1};case E0:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function DT(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new xe,d=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,x){return p?new OffscreenCanvas(E,x):tc("canvas")}function S(E,x,I){let Q=1;const re=G(E);if((re.width>I||re.height>I)&&(Q=I/Math.max(re.width,re.height)),Q<1)if(typeof HTMLImageElement!="undefined"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&E instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&E instanceof ImageBitmap||typeof VideoFrame!="undefined"&&E instanceof VideoFrame){const ne=Math.floor(Q*re.width),Te=Math.floor(Q*re.height);f===void 0&&(f=g(ne,Te));const me=x?g(ne,Te):f;return me.width=ne,me.height=Te,me.getContext("2d").drawImage(E,0,0,ne,Te),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+ne+"x"+Te+")."),me}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),E;return E}function m(E){return E.generateMipmaps}function u(E){t.generateMipmap(E)}function _(E){return E.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?t.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function v(E,x,I,Q,re=!1){if(E!==null){if(t[E]!==void 0)return t[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ne=x;if(x===t.RED&&(I===t.FLOAT&&(ne=t.R32F),I===t.HALF_FLOAT&&(ne=t.R16F),I===t.UNSIGNED_BYTE&&(ne=t.R8)),x===t.RED_INTEGER&&(I===t.UNSIGNED_BYTE&&(ne=t.R8UI),I===t.UNSIGNED_SHORT&&(ne=t.R16UI),I===t.UNSIGNED_INT&&(ne=t.R32UI),I===t.BYTE&&(ne=t.R8I),I===t.SHORT&&(ne=t.R16I),I===t.INT&&(ne=t.R32I)),x===t.RG&&(I===t.FLOAT&&(ne=t.RG32F),I===t.HALF_FLOAT&&(ne=t.RG16F),I===t.UNSIGNED_BYTE&&(ne=t.RG8)),x===t.RG_INTEGER&&(I===t.UNSIGNED_BYTE&&(ne=t.RG8UI),I===t.UNSIGNED_SHORT&&(ne=t.RG16UI),I===t.UNSIGNED_INT&&(ne=t.RG32UI),I===t.BYTE&&(ne=t.RG8I),I===t.SHORT&&(ne=t.RG16I),I===t.INT&&(ne=t.RG32I)),x===t.RGB_INTEGER&&(I===t.UNSIGNED_BYTE&&(ne=t.RGB8UI),I===t.UNSIGNED_SHORT&&(ne=t.RGB16UI),I===t.UNSIGNED_INT&&(ne=t.RGB32UI),I===t.BYTE&&(ne=t.RGB8I),I===t.SHORT&&(ne=t.RGB16I),I===t.INT&&(ne=t.RGB32I)),x===t.RGBA_INTEGER&&(I===t.UNSIGNED_BYTE&&(ne=t.RGBA8UI),I===t.UNSIGNED_SHORT&&(ne=t.RGBA16UI),I===t.UNSIGNED_INT&&(ne=t.RGBA32UI),I===t.BYTE&&(ne=t.RGBA8I),I===t.SHORT&&(ne=t.RGBA16I),I===t.INT&&(ne=t.RGBA32I)),x===t.RGB&&I===t.UNSIGNED_INT_5_9_9_9_REV&&(ne=t.RGB9_E5),x===t.RGBA){const Te=re?wc:Ze.getTransfer(Q);I===t.FLOAT&&(ne=t.RGBA32F),I===t.HALF_FLOAT&&(ne=t.RGBA16F),I===t.UNSIGNED_BYTE&&(ne=Te===ot?t.SRGB8_ALPHA8:t.RGBA8),I===t.UNSIGNED_SHORT_4_4_4_4&&(ne=t.RGBA4),I===t.UNSIGNED_SHORT_5_5_5_1&&(ne=t.RGB5_A1)}return(ne===t.R16F||ne===t.R32F||ne===t.RG16F||ne===t.RG32F||ne===t.RGBA16F||ne===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function y(E,x){let I;return E?x===null||x===Or||x===Xs?I=t.DEPTH24_STENCIL8:x===Si?I=t.DEPTH32F_STENCIL8:x===ra&&(I=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Or||x===Xs?I=t.DEPTH_COMPONENT24:x===Si?I=t.DEPTH_COMPONENT32F:x===ra&&(I=t.DEPTH_COMPONENT16),I}function P(E,x){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==qn&&E.minFilter!==ri?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function C(E){const x=E.target;x.removeEventListener("dispose",C),R(x),x.isVideoTexture&&d.delete(x)}function b(E){const x=E.target;x.removeEventListener("dispose",b),w(x)}function R(E){const x=i.get(E);if(x.__webglInit===void 0)return;const I=E.source,Q=h.get(I);if(Q){const re=Q[x.__cacheKey];re.usedTimes--,re.usedTimes===0&&T(E),Object.keys(Q).length===0&&h.delete(I)}i.remove(E)}function T(E){const x=i.get(E);t.deleteTexture(x.__webglTexture);const I=E.source,Q=h.get(I);delete Q[x.__cacheKey],o.memory.textures--}function w(E){const x=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(x.__webglFramebuffer[Q]))for(let re=0;re<x.__webglFramebuffer[Q].length;re++)t.deleteFramebuffer(x.__webglFramebuffer[Q][re]);else t.deleteFramebuffer(x.__webglFramebuffer[Q]);x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer[Q])}else{if(Array.isArray(x.__webglFramebuffer))for(let Q=0;Q<x.__webglFramebuffer.length;Q++)t.deleteFramebuffer(x.__webglFramebuffer[Q]);else t.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&t.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Q=0;Q<x.__webglColorRenderbuffer.length;Q++)x.__webglColorRenderbuffer[Q]&&t.deleteRenderbuffer(x.__webglColorRenderbuffer[Q]);x.__webglDepthRenderbuffer&&t.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const I=E.textures;for(let Q=0,re=I.length;Q<re;Q++){const ne=i.get(I[Q]);ne.__webglTexture&&(t.deleteTexture(ne.__webglTexture),o.memory.textures--),i.remove(I[Q])}i.remove(E)}let L=0;function z(){L=0}function F(){const E=L;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),L+=1,E}function j(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function Z(E,x){const I=i.get(E);if(E.isVideoTexture&&O(E),E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){const Q=E.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(I,E,x);return}}n.bindTexture(t.TEXTURE_2D,I.__webglTexture,t.TEXTURE0+x)}function X(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){Y(I,E,x);return}n.bindTexture(t.TEXTURE_2D_ARRAY,I.__webglTexture,t.TEXTURE0+x)}function ee(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){Y(I,E,x);return}n.bindTexture(t.TEXTURE_3D,I.__webglTexture,t.TEXTURE0+x)}function D(E,x){const I=i.get(E);if(E.version>0&&I.__version!==E.version){ie(I,E,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+x)}const K={[Bd]:t.REPEAT,[Cr]:t.CLAMP_TO_EDGE,[Hd]:t.MIRRORED_REPEAT},U={[qn]:t.NEAREST,[vS]:t.NEAREST_MIPMAP_NEAREST,[Ua]:t.NEAREST_MIPMAP_LINEAR,[ri]:t.LINEAR,[Qc]:t.LINEAR_MIPMAP_NEAREST,[Rr]:t.LINEAR_MIPMAP_LINEAR},te={[MS]:t.NEVER,[CS]:t.ALWAYS,[ES]:t.LESS,[D0]:t.LEQUAL,[wS]:t.EQUAL,[bS]:t.GEQUAL,[TS]:t.GREATER,[AS]:t.NOTEQUAL};function ue(E,x){if(x.type===Si&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===ri||x.magFilter===Qc||x.magFilter===Ua||x.magFilter===Rr||x.minFilter===ri||x.minFilter===Qc||x.minFilter===Ua||x.minFilter===Rr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(E,t.TEXTURE_WRAP_S,K[x.wrapS]),t.texParameteri(E,t.TEXTURE_WRAP_T,K[x.wrapT]),(E===t.TEXTURE_3D||E===t.TEXTURE_2D_ARRAY)&&t.texParameteri(E,t.TEXTURE_WRAP_R,K[x.wrapR]),t.texParameteri(E,t.TEXTURE_MAG_FILTER,U[x.magFilter]),t.texParameteri(E,t.TEXTURE_MIN_FILTER,U[x.minFilter]),x.compareFunction&&(t.texParameteri(E,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(E,t.TEXTURE_COMPARE_FUNC,te[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===qn||x.minFilter!==Ua&&x.minFilter!==Rr||x.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");t.texParameterf(E,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function we(E,x){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",C));const Q=x.source;let re=h.get(Q);re===void 0&&(re={},h.set(Q,re));const ne=j(x);if(ne!==E.__cacheKey){re[ne]===void 0&&(re[ne]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,I=!0),re[ne].usedTimes++;const Te=re[E.__cacheKey];Te!==void 0&&(re[E.__cacheKey].usedTimes--,Te.usedTimes===0&&T(x)),E.__cacheKey=ne,E.__webglTexture=re[ne].texture}return I}function Y(E,x,I){let Q=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Q=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Q=t.TEXTURE_3D);const re=we(E,x),ne=x.source;n.bindTexture(Q,E.__webglTexture,t.TEXTURE0+I);const Te=i.get(ne);if(ne.version!==Te.__version||re===!0){n.activeTexture(t.TEXTURE0+I);const me=Ze.getPrimaries(Ze.workingColorSpace),Se=x.colorSpace===Xi?null:Ze.getPrimaries(x.colorSpace),Ke=x.colorSpace===Xi||me===Se?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);let ce=S(x.image,!1,r.maxTextureSize);ce=W(x,ce);const _e=s.convert(x.format,x.colorSpace),Ae=s.convert(x.type);let Ie=v(x.internalFormat,_e,Ae,x.colorSpace,x.isVideoTexture);ue(Q,x);let Ee;const qe=x.mipmaps,ke=x.isVideoTexture!==!0,tt=Te.__version===void 0||re===!0,k=ne.dataReady,fe=P(x,ce);if(x.isDepthTexture)Ie=y(x.format===Ys,x.type),tt&&(ke?n.texStorage2D(t.TEXTURE_2D,1,Ie,ce.width,ce.height):n.texImage2D(t.TEXTURE_2D,0,Ie,ce.width,ce.height,0,_e,Ae,null));else if(x.isDataTexture)if(qe.length>0){ke&&tt&&n.texStorage2D(t.TEXTURE_2D,fe,Ie,qe[0].width,qe[0].height);for(let J=0,oe=qe.length;J<oe;J++)Ee=qe[J],ke?k&&n.texSubImage2D(t.TEXTURE_2D,J,0,0,Ee.width,Ee.height,_e,Ae,Ee.data):n.texImage2D(t.TEXTURE_2D,J,Ie,Ee.width,Ee.height,0,_e,Ae,Ee.data);x.generateMipmaps=!1}else ke?(tt&&n.texStorage2D(t.TEXTURE_2D,fe,Ie,ce.width,ce.height),k&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ce.width,ce.height,_e,Ae,ce.data)):n.texImage2D(t.TEXTURE_2D,0,Ie,ce.width,ce.height,0,_e,Ae,ce.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){ke&&tt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,Ie,qe[0].width,qe[0].height,ce.depth);for(let J=0,oe=qe.length;J<oe;J++)if(Ee=qe[J],x.format!==Xn)if(_e!==null)if(ke){if(k)if(x.layerUpdates.size>0){const ve=Om(Ee.width,Ee.height,x.format,x.type);for(const ge of x.layerUpdates){const ze=Ee.data.subarray(ge*ve/Ee.data.BYTES_PER_ELEMENT,(ge+1)*ve/Ee.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,J,0,0,ge,Ee.width,Ee.height,1,_e,ze)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,J,0,0,0,Ee.width,Ee.height,ce.depth,_e,Ee.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,J,Ie,Ee.width,Ee.height,ce.depth,0,Ee.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?k&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,J,0,0,0,Ee.width,Ee.height,ce.depth,_e,Ae,Ee.data):n.texImage3D(t.TEXTURE_2D_ARRAY,J,Ie,Ee.width,Ee.height,ce.depth,0,_e,Ae,Ee.data)}else{ke&&tt&&n.texStorage2D(t.TEXTURE_2D,fe,Ie,qe[0].width,qe[0].height);for(let J=0,oe=qe.length;J<oe;J++)Ee=qe[J],x.format!==Xn?_e!==null?ke?k&&n.compressedTexSubImage2D(t.TEXTURE_2D,J,0,0,Ee.width,Ee.height,_e,Ee.data):n.compressedTexImage2D(t.TEXTURE_2D,J,Ie,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?k&&n.texSubImage2D(t.TEXTURE_2D,J,0,0,Ee.width,Ee.height,_e,Ae,Ee.data):n.texImage2D(t.TEXTURE_2D,J,Ie,Ee.width,Ee.height,0,_e,Ae,Ee.data)}else if(x.isDataArrayTexture)if(ke){if(tt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,Ie,ce.width,ce.height,ce.depth),k)if(x.layerUpdates.size>0){const J=Om(ce.width,ce.height,x.format,x.type);for(const oe of x.layerUpdates){const ve=ce.data.subarray(oe*J/ce.data.BYTES_PER_ELEMENT,(oe+1)*J/ce.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,oe,ce.width,ce.height,1,_e,Ae,ve)}x.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,_e,Ae,ce.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Ie,ce.width,ce.height,ce.depth,0,_e,Ae,ce.data);else if(x.isData3DTexture)ke?(tt&&n.texStorage3D(t.TEXTURE_3D,fe,Ie,ce.width,ce.height,ce.depth),k&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,_e,Ae,ce.data)):n.texImage3D(t.TEXTURE_3D,0,Ie,ce.width,ce.height,ce.depth,0,_e,Ae,ce.data);else if(x.isFramebufferTexture){if(tt)if(ke)n.texStorage2D(t.TEXTURE_2D,fe,Ie,ce.width,ce.height);else{let J=ce.width,oe=ce.height;for(let ve=0;ve<fe;ve++)n.texImage2D(t.TEXTURE_2D,ve,Ie,J,oe,0,_e,Ae,null),J>>=1,oe>>=1}}else if(qe.length>0){if(ke&&tt){const J=G(qe[0]);n.texStorage2D(t.TEXTURE_2D,fe,Ie,J.width,J.height)}for(let J=0,oe=qe.length;J<oe;J++)Ee=qe[J],ke?k&&n.texSubImage2D(t.TEXTURE_2D,J,0,0,_e,Ae,Ee):n.texImage2D(t.TEXTURE_2D,J,Ie,_e,Ae,Ee);x.generateMipmaps=!1}else if(ke){if(tt){const J=G(ce);n.texStorage2D(t.TEXTURE_2D,fe,Ie,J.width,J.height)}k&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e,Ae,ce)}else n.texImage2D(t.TEXTURE_2D,0,Ie,_e,Ae,ce);m(x)&&u(Q),Te.__version=ne.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function ie(E,x,I){if(x.image.length!==6)return;const Q=we(E,x),re=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,E.__webglTexture,t.TEXTURE0+I);const ne=i.get(re);if(re.version!==ne.__version||Q===!0){n.activeTexture(t.TEXTURE0+I);const Te=Ze.getPrimaries(Ze.workingColorSpace),me=x.colorSpace===Xi?null:Ze.getPrimaries(x.colorSpace),Se=x.colorSpace===Xi||Te===me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ke=x.isCompressedTexture||x.image[0].isCompressedTexture,ce=x.image[0]&&x.image[0].isDataTexture,_e=[];for(let oe=0;oe<6;oe++)!Ke&&!ce?_e[oe]=S(x.image[oe],!0,r.maxCubemapSize):_e[oe]=ce?x.image[oe].image:x.image[oe],_e[oe]=W(x,_e[oe]);const Ae=_e[0],Ie=s.convert(x.format,x.colorSpace),Ee=s.convert(x.type),qe=v(x.internalFormat,Ie,Ee,x.colorSpace),ke=x.isVideoTexture!==!0,tt=ne.__version===void 0||Q===!0,k=re.dataReady;let fe=P(x,Ae);ue(t.TEXTURE_CUBE_MAP,x);let J;if(Ke){ke&&tt&&n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,qe,Ae.width,Ae.height);for(let oe=0;oe<6;oe++){J=_e[oe].mipmaps;for(let ve=0;ve<J.length;ve++){const ge=J[ve];x.format!==Xn?Ie!==null?ke?k&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve,0,0,ge.width,ge.height,Ie,ge.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve,qe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ke?k&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve,0,0,ge.width,ge.height,Ie,Ee,ge.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve,qe,ge.width,ge.height,0,Ie,Ee,ge.data)}}}else{if(J=x.mipmaps,ke&&tt){J.length>0&&fe++;const oe=G(_e[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,qe,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(ce){ke?k&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,_e[oe].width,_e[oe].height,Ie,Ee,_e[oe].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,qe,_e[oe].width,_e[oe].height,0,Ie,Ee,_e[oe].data);for(let ve=0;ve<J.length;ve++){const ze=J[ve].image[oe].image;ke?k&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve+1,0,0,ze.width,ze.height,Ie,Ee,ze.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve+1,qe,ze.width,ze.height,0,Ie,Ee,ze.data)}}else{ke?k&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Ie,Ee,_e[oe]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,qe,Ie,Ee,_e[oe]);for(let ve=0;ve<J.length;ve++){const ge=J[ve];ke?k&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve+1,0,0,Ie,Ee,ge.image[oe]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ve+1,qe,Ie,Ee,ge.image[oe])}}}m(x)&&u(t.TEXTURE_CUBE_MAP),ne.__version=re.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function he(E,x,I,Q,re,ne){const Te=s.convert(I.format,I.colorSpace),me=s.convert(I.type),Se=v(I.internalFormat,Te,me,I.colorSpace),Ke=i.get(x),ce=i.get(I);if(ce.__renderTarget=x,!Ke.__hasExternalTextures){const _e=Math.max(1,x.width>>ne),Ae=Math.max(1,x.height>>ne);re===t.TEXTURE_3D||re===t.TEXTURE_2D_ARRAY?n.texImage3D(re,ne,Se,_e,Ae,x.depth,0,Te,me,null):n.texImage2D(re,ne,Se,_e,Ae,0,Te,me,null)}n.bindFramebuffer(t.FRAMEBUFFER,E),Ge(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,re,ce.__webglTexture,0,Ue(x)):(re===t.TEXTURE_2D||re>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Q,re,ce.__webglTexture,ne),n.bindFramebuffer(t.FRAMEBUFFER,null)}function se(E,x,I){if(t.bindRenderbuffer(t.RENDERBUFFER,E),x.depthBuffer){const Q=x.depthTexture,re=Q&&Q.isDepthTexture?Q.type:null,ne=y(x.stencilBuffer,re),Te=x.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,me=Ue(x);Ge(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,me,ne,x.width,x.height):I?t.renderbufferStorageMultisample(t.RENDERBUFFER,me,ne,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,ne,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Te,t.RENDERBUFFER,E)}else{const Q=x.textures;for(let re=0;re<Q.length;re++){const ne=Q[re],Te=s.convert(ne.format,ne.colorSpace),me=s.convert(ne.type),Se=v(ne.internalFormat,Te,me,ne.colorSpace),Ke=Ue(x);I&&Ge(x)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ke,Se,x.width,x.height):Ge(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ke,Se,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,Se,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Le(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=i.get(x.depthTexture);Q.__renderTarget=x,(!Q.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),Z(x.depthTexture,0);const re=Q.__webglTexture,ne=Ue(x);if(x.depthTexture.format===Is)Ge(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,re,0,ne):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,re,0);else if(x.depthTexture.format===Ys)Ge(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,re,0,ne):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,re,0);else throw new Error("Unknown depthTexture format")}function Ne(E){const x=i.get(E),I=E.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==E.depthTexture){const Q=E.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Q){const re=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Q.removeEventListener("dispose",re)};Q.addEventListener("dispose",re),x.__depthDisposeCallback=re}x.__boundDepthTexture=Q}if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");Le(x.__webglFramebuffer,E)}else if(I){x.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[Q]),x.__webglDepthbuffer[Q]===void 0)x.__webglDepthbuffer[Q]=t.createRenderbuffer(),se(x.__webglDepthbuffer[Q],E,!1);else{const re=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=x.__webglDepthbuffer[Q];t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,re,t.RENDERBUFFER,ne)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=t.createRenderbuffer(),se(x.__webglDepthbuffer,E,!1);else{const Q=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=x.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,Q,t.RENDERBUFFER,re)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Be(E,x,I){const Q=i.get(E);x!==void 0&&he(Q.__webglFramebuffer,E,E.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),I!==void 0&&Ne(E)}function Xe(E){const x=E.texture,I=i.get(E),Q=i.get(x);E.addEventListener("dispose",b);const re=E.textures,ne=E.isWebGLCubeRenderTarget===!0,Te=re.length>1;if(Te||(Q.__webglTexture===void 0&&(Q.__webglTexture=t.createTexture()),Q.__version=x.version,o.memory.textures++),ne){I.__webglFramebuffer=[];for(let me=0;me<6;me++)if(x.mipmaps&&x.mipmaps.length>0){I.__webglFramebuffer[me]=[];for(let Se=0;Se<x.mipmaps.length;Se++)I.__webglFramebuffer[me][Se]=t.createFramebuffer()}else I.__webglFramebuffer[me]=t.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){I.__webglFramebuffer=[];for(let me=0;me<x.mipmaps.length;me++)I.__webglFramebuffer[me]=t.createFramebuffer()}else I.__webglFramebuffer=t.createFramebuffer();if(Te)for(let me=0,Se=re.length;me<Se;me++){const Ke=i.get(re[me]);Ke.__webglTexture===void 0&&(Ke.__webglTexture=t.createTexture(),o.memory.textures++)}if(E.samples>0&&Ge(E)===!1){I.__webglMultisampledFramebuffer=t.createFramebuffer(),I.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let me=0;me<re.length;me++){const Se=re[me];I.__webglColorRenderbuffer[me]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,I.__webglColorRenderbuffer[me]);const Ke=s.convert(Se.format,Se.colorSpace),ce=s.convert(Se.type),_e=v(Se.internalFormat,Ke,ce,Se.colorSpace,E.isXRRenderTarget===!0),Ae=Ue(E);t.renderbufferStorageMultisample(t.RENDERBUFFER,Ae,_e,E.width,E.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,I.__webglColorRenderbuffer[me])}t.bindRenderbuffer(t.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=t.createRenderbuffer(),se(I.__webglDepthRenderbuffer,E,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ne){n.bindTexture(t.TEXTURE_CUBE_MAP,Q.__webglTexture),ue(t.TEXTURE_CUBE_MAP,x);for(let me=0;me<6;me++)if(x.mipmaps&&x.mipmaps.length>0)for(let Se=0;Se<x.mipmaps.length;Se++)he(I.__webglFramebuffer[me][Se],E,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Se);else he(I.__webglFramebuffer[me],E,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0);m(x)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Te){for(let me=0,Se=re.length;me<Se;me++){const Ke=re[me],ce=i.get(Ke);n.bindTexture(t.TEXTURE_2D,ce.__webglTexture),ue(t.TEXTURE_2D,Ke),he(I.__webglFramebuffer,E,Ke,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,0),m(Ke)&&u(t.TEXTURE_2D)}n.unbindTexture()}else{let me=t.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(me=E.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(me,Q.__webglTexture),ue(me,x),x.mipmaps&&x.mipmaps.length>0)for(let Se=0;Se<x.mipmaps.length;Se++)he(I.__webglFramebuffer[Se],E,x,t.COLOR_ATTACHMENT0,me,Se);else he(I.__webglFramebuffer,E,x,t.COLOR_ATTACHMENT0,me,0);m(x)&&u(me),n.unbindTexture()}E.depthBuffer&&Ne(E)}function Oe(E){const x=E.textures;for(let I=0,Q=x.length;I<Q;I++){const re=x[I];if(m(re)){const ne=_(E),Te=i.get(re).__webglTexture;n.bindTexture(ne,Te),u(ne),n.unbindTexture()}}}const pt=[],B=[];function Rt(E){if(E.samples>0){if(Ge(E)===!1){const x=E.textures,I=E.width,Q=E.height;let re=t.COLOR_BUFFER_BIT;const ne=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Te=i.get(E),me=x.length>1;if(me)for(let Se=0;Se<x.length;Se++)n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Se,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Se,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Se=0;Se<x.length;Se++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(re|=t.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(re|=t.STENCIL_BUFFER_BIT)),me){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Te.__webglColorRenderbuffer[Se]);const Ke=i.get(x[Se]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ke,0)}t.blitFramebuffer(0,0,I,Q,0,0,I,Q,re,t.NEAREST),l===!0&&(pt.length=0,B.length=0,pt.push(t.COLOR_ATTACHMENT0+Se),E.depthBuffer&&E.resolveDepthBuffer===!1&&(pt.push(ne),B.push(ne),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,B)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,pt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),me)for(let Se=0;Se<x.length;Se++){n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Se,t.RENDERBUFFER,Te.__webglColorRenderbuffer[Se]);const Ke=i.get(x[Se]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Te.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Se,t.TEXTURE_2D,Ke,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const x=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[x])}}}function Ue(E){return Math.min(r.maxSamples,E.samples)}function Ge(E){const x=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function O(E){const x=o.render.frame;d.get(E)!==x&&(d.set(E,x),E.update())}function W(E,x){const I=E.colorSpace,Q=E.format,re=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||I!==Js&&I!==Xi&&(Ze.getTransfer(I)===ot?(Q!==Xn||re!==Pi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),x}function G(E){return typeof HTMLImageElement!="undefined"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame!="undefined"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=z,this.setTexture2D=Z,this.setTexture2DArray=X,this.setTexture3D=ee,this.setTextureCube=D,this.rebindTextures=Be,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=Oe,this.updateMultisampleRenderTarget=Rt,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=he,this.useMultisampledRTT=Ge}function NT(t,e){function n(i,r=Xi){let s;const o=Ze.getTransfer(r);if(i===Pi)return t.UNSIGNED_BYTE;if(i===gf)return t.UNSIGNED_SHORT_4_4_4_4;if(i===_f)return t.UNSIGNED_SHORT_5_5_5_1;if(i===E0)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===S0)return t.BYTE;if(i===M0)return t.SHORT;if(i===ra)return t.UNSIGNED_SHORT;if(i===mf)return t.INT;if(i===Or)return t.UNSIGNED_INT;if(i===Si)return t.FLOAT;if(i===ua)return t.HALF_FLOAT;if(i===w0)return t.ALPHA;if(i===T0)return t.RGB;if(i===Xn)return t.RGBA;if(i===A0)return t.LUMINANCE;if(i===b0)return t.LUMINANCE_ALPHA;if(i===Is)return t.DEPTH_COMPONENT;if(i===Ys)return t.DEPTH_STENCIL;if(i===C0)return t.RED;if(i===vf)return t.RED_INTEGER;if(i===R0)return t.RG;if(i===yf)return t.RG_INTEGER;if(i===xf)return t.RGBA_INTEGER;if(i===El||i===wl||i===Tl||i===Al)if(o===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===El)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===El)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===wl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Tl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Al)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Vd||i===Gd||i===Wd||i===jd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Vd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Gd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Wd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===jd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Xd||i===Yd||i===$d)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Xd||i===Yd)return o===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===$d)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===qd||i===Kd||i===Zd||i===Jd||i===Qd||i===eh||i===th||i===nh||i===ih||i===rh||i===sh||i===oh||i===ah||i===lh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===qd)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Kd)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Zd)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Jd)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Qd)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===eh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===th)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===nh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ih)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===rh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===sh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===oh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ah)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===lh)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===bl||i===ch||i===uh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===bl)return o===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ch)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===uh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===P0||i===dh||i===hh||i===fh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===dh)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===hh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Xs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class IT extends Ln{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ei extends Nt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const UT={type:"move"};class bu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ei,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ei,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ei,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const S of e.hand.values()){const m=n.getJointPose(S,i),u=this._getHandJoint(c,S);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const d=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=d.position.distanceTo(f.position),p=.02,g=.005;c.inputState.pinching&&h>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(UT)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Ei;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const FT=`
void main() {
...
}`;class kT{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new nn,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new cr({vertexShader:FT,fragmentShader:OT,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new De(new fa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class zT extends Gr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,d=null,f=null,h=null,p=null,g=null;const S=new kT,m=n.getContextAttributes();let u=null,_=null;const v=[],y=[],P=new xe;let C=null;const b=new Ln;b.viewport=new Tt;const R=new Ln;R.viewport=new Tt;const T=[b,R],w=new IT;let L=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let ie=v[Y];return ie===void 0&&(ie=new bu,v[Y]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function(Y){let ie=v[Y];return ie===void 0&&(ie=new bu,v[Y]=ie),ie.getGripSpace()},this.getHand=function(Y){let ie=v[Y];return ie===void 0&&(ie=new bu,v[Y]=ie),ie.getHandSpace()};function F(Y){const ie=y.indexOf(Y.inputSource);if(ie===-1)return;const he=v[ie];he!==void 0&&(he.update(Y.inputSource,Y.frame,c||o),he.dispatchEvent({type:Y.type,data:Y.inputSource}))}function j(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",j),r.removeEventListener("inputsourceschange",Z);for(let Y=0;Y<v.length;Y++){const ie=y[Y];ie!==null&&(y[Y]=null,v[Y].disconnect(ie))}L=null,z=null,S.reset(),e.setRenderTarget(u),p=null,h=null,f=null,r=null,_=null,we.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){a=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",j),r.addEventListener("inputsourceschange",Z),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const ie={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,ie),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),_=new kr(p.framebufferWidth,p.framebufferHeight,{format:Xn,type:Pi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let ie=null,he=null,se=null;m.depth&&(se=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ie=m.stencil?Ys:Is,he=m.stencil?Xs:Or);const Le={colorFormat:n.RGBA8,depthFormat:se,scaleFactor:s};f=new XRWebGLBinding(r,n),h=f.createProjectionLayer(Le),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),_=new kr(h.textureWidth,h.textureHeight,{format:Xn,type:Pi,depthTexture:new j0(h.textureWidth,h.textureHeight,he,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1})}_.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),we.setContext(r),we.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function Z(Y){for(let ie=0;ie<Y.removed.length;ie++){const he=Y.removed[ie],se=y.indexOf(he);se>=0&&(y[se]=null,v[se].disconnect(he))}for(let ie=0;ie<Y.added.length;ie++){const he=Y.added[ie];let se=y.indexOf(he);if(se===-1){for(let Ne=0;Ne<v.length;Ne++)if(Ne>=y.length){y.push(he),se=Ne;break}else if(y[Ne]===null){y[Ne]=he,se=Ne;break}if(se===-1)break}const Le=v[se];Le&&Le.connect(he)}}const X=new N,ee=new N;function D(Y,ie,he){X.setFromMatrixPosition(ie.matrixWorld),ee.setFromMatrixPosition(he.matrixWorld);const se=X.distanceTo(ee),Le=ie.projectionMatrix.elements,Ne=he.projectionMatrix.elements,Be=Le[14]/(Le[10]-1),Xe=Le[14]/(Le[10]+1),Oe=(Le[9]+1)/Le[5],pt=(Le[9]-1)/Le[5],B=(Le[8]-1)/Le[0],Rt=(Ne[8]+1)/Ne[0],Ue=Be*B,Ge=Be*Rt,O=se/(-B+Rt),W=O*-B;if(ie.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(W),Y.translateZ(O),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Le[10]===-1)Y.projectionMatrix.copy(ie.projectionMatrix),Y.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{const G=Be+O,E=Xe+O,x=Ue-W,I=Ge+(se-W),Q=Oe*Xe/E*G,re=pt*Xe/E*G;Y.projectionMatrix.makePerspective(x,I,Q,re,G,E),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function K(Y,ie){ie===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(ie.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let ie=Y.near,he=Y.far;S.texture!==null&&(S.depthNear>0&&(ie=S.depthNear),S.depthFar>0&&(he=S.depthFar)),w.near=R.near=b.near=ie,w.far=R.far=b.far=he,(L!==w.near||z!==w.far)&&(r.updateRenderState({depthNear:w.near,depthFar:w.far}),L=w.near,z=w.far),b.layers.mask=Y.layers.mask|2,R.layers.mask=Y.layers.mask|4,w.layers.mask=b.layers.mask|R.layers.mask;const se=Y.parent,Le=w.cameras;K(w,se);for(let Ne=0;Ne<Le.length;Ne++)K(Le[Ne],se);Le.length===2?D(w,b,R):w.projectionMatrix.copy(b.projectionMatrix),U(Y,w,se)};function U(Y,ie,he){he===null?Y.matrix.copy(ie.matrixWorld):(Y.matrix.copy(he.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(ie.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(ie.projectionMatrix),Y.projectionMatrixInverse.copy(ie.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=mh*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return w},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(Y){l=Y,h!==null&&(h.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(w)};let te=null;function ue(Y,ie){if(d=ie.getViewerPose(c||o),g=ie,d!==null){const he=d.views;p!==null&&(e.setRenderTargetFramebuffer(_,p.framebuffer),e.setRenderTarget(_));let se=!1;he.length!==w.cameras.length&&(w.cameras.length=0,se=!0);for(let Ne=0;Ne<he.length;Ne++){const Be=he[Ne];let Xe=null;if(p!==null)Xe=p.getViewport(Be);else{const pt=f.getViewSubImage(h,Be);Xe=pt.viewport,Ne===0&&(e.setRenderTargetTextures(_,pt.colorTexture,h.ignoreDepthValues?void 0:pt.depthStencilTexture),e.setRenderTarget(_))}let Oe=T[Ne];Oe===void 0&&(Oe=new Ln,Oe.layers.enable(Ne),Oe.viewport=new Tt,T[Ne]=Oe),Oe.matrix.fromArray(Be.transform.matrix),Oe.matrix.decompose(Oe.position,Oe.quaternion,Oe.scale),Oe.projectionMatrix.fromArray(Be.projectionMatrix),Oe.projectionMatrixInverse.copy(Oe.projectionMatrix).invert(),Oe.viewport.set(Xe.x,Xe.y,Xe.width,Xe.height),Ne===0&&(w.matrix.copy(Oe.matrix),w.matrix.decompose(w.position,w.quaternion,w.scale)),se===!0&&w.cameras.push(Oe)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")){const Ne=f.getDepthInformation(he[0]);Ne&&Ne.isValid&&Ne.texture&&S.init(e,Ne,r.renderState)}}for(let he=0;he<v.length;he++){const se=y[he],Le=v[he];se!==null&&Le!==void 0&&Le.update(se,ie,c||o)}te&&te(Y,ie),ie.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ie}),g=null}const we=new G0;we.setAnimationLoop(ue),this.setAnimationLoop=function(Y){te=Y},this.dispose=function(){}}}const yr=new ai,BT=new ct;function HT(t,e){function n(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,B0(t)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,_,v,y){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(m,u):u.isMeshToonMaterial?(s(m,u),f(m,u)):u.isMeshPhongMaterial?(s(m,u),d(m,u)):u.isMeshStandardMaterial?(s(m,u),h(m,u),u.isMeshPhysicalMaterial&&p(m,u,y)):u.isMeshMatcapMaterial?(s(m,u),g(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),S(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(o(m,u),u.isLineDashedMaterial&&a(m,u)):u.isPointsMaterial?l(m,u,_,v):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,n(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===pn&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,n(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===pn&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,n(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,n(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const _=e.get(u),v=_.envMap,y=_.envMapRotation;v&&(m.envMap.value=v,yr.copy(y),yr.x*=-1,yr.y*=-1,yr.z*=-1,v.isCubeTexture&&v.isRenderTargetTexture===!1&&(yr.y*=-1,yr.z*=-1),m.envMapRotation.value.setFromMatrix4(BT.makeRotationFromEuler(yr)),m.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,m.aoMapTransform))}function o(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform))}function a(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,_,v){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*_,m.scale.value=v*.5,u.map&&(m.map.value=u.map,n(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function f(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,_){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===pn&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=_.texture,m.transmissionSamplerSize.value.set(_.width,_.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,u){u.matcap&&(m.matcap.value=u.matcap)}function S(m,u){const _=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(_.matrixWorld),m.nearDistance.value=_.shadow.camera.near,m.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function VT(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(_,v){const y=v.program;i.uniformBlockBinding(_,y)}function c(_,v){let y=r[_.id];y===void 0&&(g(_),y=d(_),r[_.id]=y,_.addEventListener("dispose",m));const P=v.program;i.updateUBOMapping(_,P);const C=e.render.frame;s[_.id]!==C&&(h(_),s[_.id]=C)}function d(_){const v=f();_.__bindingPointIndex=v;const y=t.createBuffer(),P=_.__size,C=_.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,P,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,v,y),y}function f(){for(let _=0;_<a;_++)if(o.indexOf(_)===-1)return o.push(_),_;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(_){const v=r[_.id],y=_.uniforms,P=_.__cache;t.bindBuffer(t.UNIFORM_BUFFER,v);for(let C=0,b=y.length;C<b;C++){const R=Array.isArray(y[C])?y[C]:[y[C]];for(let T=0,w=R.length;T<w;T++){const L=R[T];if(p(L,C,T,P)===!0){const z=L.__offset,F=Array.isArray(L.value)?L.value:[L.value];let j=0;for(let Z=0;Z<F.length;Z++){const X=F[Z],ee=S(X);typeof X=="number"||typeof X=="boolean"?(L.__data[0]=X,t.bufferSubData(t.UNIFORM_BUFFER,z+j,L.__data)):X.isMatrix3?(L.__data[0]=X.elements[0],L.__data[1]=X.elements[1],L.__data[2]=X.elements[2],L.__data[3]=0,L.__data[4]=X.elements[3],L.__data[5]=X.elements[4],L.__data[6]=X.elements[5],L.__data[7]=0,L.__data[8]=X.elements[6],L.__data[9]=X.elements[7],L.__data[10]=X.elements[8],L.__data[11]=0):(X.toArray(L.__data,j),j+=ee.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,z,L.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(_,v,y,P){const C=_.value,b=v+"_"+y;if(P[b]===void 0)return typeof C=="number"||typeof C=="boolean"?P[b]=C:P[b]=C.clone(),!0;{const R=P[b];if(typeof C=="number"||typeof C=="boolean"){if(R!==C)return P[b]=C,!0}else if(R.equals(C)===!1)return R.copy(C),!0}return!1}function g(_){const v=_.uniforms;let y=0;const P=16;for(let b=0,R=v.length;b<R;b++){const T=Array.isArray(v[b])?v[b]:[v[b]];for(let w=0,L=T.length;w<L;w++){const z=T[w],F=Array.isArray(z.value)?z.value:[z.value];for(let j=0,Z=F.length;j<Z;j++){const X=F[j],ee=S(X),D=y%P,K=D%ee.boundary,U=D+K;y+=K,U!==0&&P-U<ee.storage&&(y+=P-U),z.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=y,y+=ee.storage}}}const C=y%P;return C>0&&(y+=P-C),_.__size=y,_.__cache={},this}function S(_){const v={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(v.boundary=4,v.storage=4):_.isVector2?(v.boundary=8,v.storage=8):_.isVector3||_.isColor?(v.boundary=16,v.storage=12):_.isVector4?(v.boundary=16,v.storage=16):_.isMatrix3?(v.boundary=48,v.storage=48):_.isMatrix4?(v.boundary=64,v.storage=64):_.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",_),v}function m(_){const v=_.target;v.removeEventListener("dispose",m);const y=o.indexOf(v.__bindingPointIndex);o.splice(y,1),t.deleteBuffer(r[v.id]),delete r[v.id],delete s[v.id]}function u(){for(const _ in r)t.deleteBuffer(r[_]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class GT{constructor(e={}){const{canvas:n=LS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1,reverseDepthBuffer:h=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext!="undefined"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const g=new Uint32Array(4),S=new Int32Array(4);let m=null,u=null;const _=[],v=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Cn,this.toneMapping=rr,this.toneMappingExposure=1;const y=this;let P=!1,C=0,b=0,R=null,T=-1,w=null;const L=new Tt,z=new Tt;let F=null;const j=new Ye(0);let Z=0,X=n.width,ee=n.height,D=1,K=null,U=null;const te=new Tt(0,0,X,ee),ue=new Tt(0,0,X,ee);let we=!1;const Y=new Mf;let ie=!1,he=!1;const se=new ct,Le=new ct,Ne=new N,Be=new Tt,Xe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Oe=!1;function pt(){return R===null?D:1}let B=i;function Rt(A,H){return n.getContext(A,H)}try{const A={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${pf}`),n.addEventListener("webglcontextlost",oe,!1),n.addEventListener("webglcontextrestored",ve,!1),n.addEventListener("webglcontextcreationerror",ge,!1),B===null){const H="webgl2";if(B=Rt(H,A),B===null)throw Rt(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let Ue,Ge,O,W,G,E,x,I,Q,re,ne,Te,me,Se,Ke,ce,_e,Ae,Ie,Ee,qe,ke,tt,k;function fe(){Ue=new $w(B),Ue.init(),ke=new NT(B,Ue),Ge=new Vw(B,Ue,e,ke),O=new PT(B,Ue),Ge.reverseDepthBuffer&&h&&O.buffers.depth.setReversed(!0),W=new Zw(B),G=new mT,E=new DT(B,Ue,O,G,Ge,ke,W),x=new Ww(y),I=new Yw(y),Q=new rM(B),tt=new Bw(B,Q),re=new qw(B,Q,W,tt),ne=new Qw(B,re,Q,W),Ie=new Jw(B,Ge,E),ce=new Gw(G),Te=new pT(y,x,I,Ue,Ge,tt,ce),me=new HT(y,G),Se=new _T,Ke=new ET(Ue),Ae=new zw(y,x,I,O,ne,p,l),_e=new CT(y,ne,Ge),k=new VT(B,W,Ge,O),Ee=new Hw(B,Ue,W),qe=new Kw(B,Ue,W),W.programs=Te.programs,y.capabilities=Ge,y.extensions=Ue,y.properties=G,y.renderLists=Se,y.shadowMap=_e,y.state=O,y.info=W}fe();const J=new zT(y,B);this.xr=J,this.getContext=function(){return B},this.getContextAttributes=function(){return B.getContextAttributes()},this.forceContextLoss=function(){const A=Ue.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Ue.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return D},this.setPixelRatio=function(A){A!==void 0&&(D=A,this.setSize(X,ee,!1))},this.getSize=function(A){return A.set(X,ee)},this.setSize=function(A,H,$=!0){if(J.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=A,ee=H,n.width=Math.floor(A*D),n.height=Math.floor(H*D),$===!0&&(n.style.width=A+"px",n.style.height=H+"px"),this.setViewport(0,0,A,H)},this.getDrawingBufferSize=function(A){return A.set(X*D,ee*D).floor()},this.setDrawingBufferSize=function(A,H,$){X=A,ee=H,D=$,n.width=Math.floor(A*$),n.height=Math.floor(H*$),this.setViewport(0,0,A,H)},this.getCurrentViewport=function(A){return A.copy(L)},this.getViewport=function(A){return A.copy(te)},this.setViewport=function(A,H,$,q){A.isVector4?te.set(A.x,A.y,A.z,A.w):te.set(A,H,$,q),O.viewport(L.copy(te).multiplyScalar(D).round())},this.getScissor=function(A){return A.copy(ue)},this.setScissor=function(A,H,$,q){A.isVector4?ue.set(A.x,A.y,A.z,A.w):ue.set(A,H,$,q),O.scissor(z.copy(ue).multiplyScalar(D).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(A){O.setScissorTest(we=A)},this.setOpaqueSort=function(A){K=A},this.setTransparentSort=function(A){U=A},this.getClearColor=function(A){return A.copy(Ae.getClearColor())},this.setClearColor=function(){Ae.setClearColor.apply(Ae,arguments)},this.getClearAlpha=function(){return Ae.getClearAlpha()},this.setClearAlpha=function(){Ae.setClearAlpha.apply(Ae,arguments)},this.clear=function(A=!0,H=!0,$=!0){let q=0;if(A){let V=!1;if(R!==null){const de=R.texture.format;V=de===xf||de===yf||de===vf}if(V){const de=R.texture.type,ye=de===Pi||de===Or||de===ra||de===Xs||de===gf||de===_f,be=Ae.getClearColor(),Ce=Ae.getClearAlpha(),Fe=be.r,He=be.g,Re=be.b;ye?(g[0]=Fe,g[1]=He,g[2]=Re,g[3]=Ce,B.clearBufferuiv(B.COLOR,0,g)):(S[0]=Fe,S[1]=He,S[2]=Re,S[3]=Ce,B.clearBufferiv(B.COLOR,0,S))}else q|=B.COLOR_BUFFER_BIT}H&&(q|=B.DEPTH_BUFFER_BIT),$&&(q|=B.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",oe,!1),n.removeEventListener("webglcontextrestored",ve,!1),n.removeEventListener("webglcontextcreationerror",ge,!1),Se.dispose(),Ke.dispose(),G.dispose(),x.dispose(),I.dispose(),ne.dispose(),tt.dispose(),k.dispose(),Te.dispose(),J.dispose(),J.removeEventListener("sessionstart",Ac),J.removeEventListener("sessionend",pa),Zn.stop()};function oe(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),P=!0}function ve(){console.log("THREE.WebGLRenderer: Context Restored."),P=!1;const A=W.autoReset,H=_e.enabled,$=_e.autoUpdate,q=_e.needsUpdate,V=_e.type;fe(),W.autoReset=A,_e.enabled=H,_e.autoUpdate=$,_e.needsUpdate=q,_e.type=V}function ge(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function ze(A){const H=A.target;H.removeEventListener("dispose",ze),yt(H)}function yt(A){Ft(A),G.remove(A)}function Ft(A){const H=G.get(A).programs;H!==void 0&&(H.forEach(function($){Te.releaseProgram($)}),A.isShaderMaterial&&Te.releaseShaderCache(A))}this.renderBufferDirect=function(A,H,$,q,V,de){H===null&&(H=Xe);const ye=V.isMesh&&V.matrixWorld.determinant()<0,be=ov(A,H,$,q,V);O.setMaterial(q,ye);let Ce=$.index,Fe=1;if(q.wireframe===!0){if(Ce=re.getWireframeAttribute($),Ce===void 0)return;Fe=2}const He=$.drawRange,Re=$.attributes.position;let Qe=He.start*Fe,ut=(He.start+He.count)*Fe;de!==null&&(Qe=Math.max(Qe,de.start*Fe),ut=Math.min(ut,(de.start+de.count)*Fe)),Ce!==null?(Qe=Math.max(Qe,0),ut=Math.min(ut,Ce.count)):Re!=null&&(Qe=Math.max(Qe,0),ut=Math.min(ut,Re.count));const mt=ut-Qe;if(mt<0||mt===1/0)return;tt.setup(V,q,be,$,Ce);let an,nt=Ee;if(Ce!==null&&(an=Q.get(Ce),nt=qe,nt.setIndex(an)),V.isMesh)q.wireframe===!0?(O.setLineWidth(q.wireframeLinewidth*pt()),nt.setMode(B.LINES)):nt.setMode(B.TRIANGLES);else if(V.isLine){let Pe=q.linewidth;Pe===void 0&&(Pe=1),O.setLineWidth(Pe*pt()),V.isLineSegments?nt.setMode(B.LINES):V.isLineLoop?nt.setMode(B.LINE_LOOP):nt.setMode(B.LINE_STRIP)}else V.isPoints?nt.setMode(B.POINTS):V.isSprite&&nt.setMode(B.TRIANGLES);if(V.isBatchedMesh)if(V._multiDrawInstances!==null)nt.renderMultiDrawInstances(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount,V._multiDrawInstances);else if(Ue.get("WEBGL_multi_draw"))nt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const Pe=V._multiDrawStarts,li=V._multiDrawCounts,it=V._multiDrawCount,kn=Ce?Q.get(Ce).bytesPerElement:1,Wr=G.get(q).currentProgram.getUniforms();for(let mn=0;mn<it;mn++)Wr.setValue(B,"_gl_DrawID",mn),nt.render(Pe[mn]/kn,li[mn])}else if(V.isInstancedMesh)nt.renderInstances(Qe,mt,V.count);else if($.isInstancedBufferGeometry){const Pe=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,li=Math.min($.instanceCount,Pe);nt.renderInstances(Qe,mt,li)}else nt.render(Qe,mt)};function et(A,H,$){A.transparent===!0&&A.side===vi&&A.forceSinglePass===!1?(A.side=pn,A.needsUpdate=!0,ga(A,H,$),A.side=lr,A.needsUpdate=!0,ga(A,H,$),A.side=vi):ga(A,H,$)}this.compile=function(A,H,$=null){$===null&&($=A),u=Ke.get($),u.init(H),v.push(u),$.traverseVisible(function(V){V.isLight&&V.layers.test(H.layers)&&(u.pushLight(V),V.castShadow&&u.pushShadow(V))}),A!==$&&A.traverseVisible(function(V){V.isLight&&V.layers.test(H.layers)&&(u.pushLight(V),V.castShadow&&u.pushShadow(V))}),u.setupLights();const q=new Set;return A.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const de=V.material;if(de)if(Array.isArray(de))for(let ye=0;ye<de.length;ye++){const be=de[ye];et(be,$,V),q.add(be)}else et(de,$,V),q.add(de)}),v.pop(),u=null,q},this.compileAsync=function(A,H,$=null){const q=this.compile(A,H,$);return new Promise(V=>{function de(){if(q.forEach(function(ye){G.get(ye).currentProgram.isReady()&&q.delete(ye)}),q.size===0){V(A);return}setTimeout(de,10)}Ue.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let on=null;function wn(A){on&&on(A)}function Ac(){Zn.stop()}function pa(){Zn.start()}const Zn=new G0;Zn.setAnimationLoop(wn),typeof self!="undefined"&&Zn.setContext(self),this.setAnimationLoop=function(A){on=A,J.setAnimationLoop(A),A===null?Zn.stop():Zn.start()},J.addEventListener("sessionstart",Ac),J.addEventListener("sessionend",pa),this.render=function(A,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),J.enabled===!0&&J.isPresenting===!0&&(J.cameraAutoUpdate===!0&&J.updateCamera(H),H=J.getCamera()),A.isScene===!0&&A.onBeforeRender(y,A,H,R),u=Ke.get(A,v.length),u.init(H),v.push(u),Le.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),Y.setFromProjectionMatrix(Le),he=this.localClippingEnabled,ie=ce.init(this.clippingPlanes,he),m=Se.get(A,_.length),m.init(),_.push(m),J.enabled===!0&&J.isPresenting===!0){const de=y.xr.getDepthSensingMesh();de!==null&&eo(de,H,-1/0,y.sortObjects)}eo(A,H,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(K,U),Oe=J.enabled===!1||J.isPresenting===!1||J.hasDepthSensing()===!1,Oe&&Ae.addToRenderList(m,A),this.info.render.frame++,ie===!0&&ce.beginShadows();const $=u.state.shadowsArray;_e.render($,A,H),ie===!0&&ce.endShadows(),this.info.autoReset===!0&&this.info.reset();const q=m.opaque,V=m.transmissive;if(u.setupLights(),H.isArrayCamera){const de=H.cameras;if(V.length>0)for(let ye=0,be=de.length;ye<be;ye++){const Ce=de[ye];ma(q,V,A,Ce)}Oe&&Ae.render(A);for(let ye=0,be=de.length;ye<be;ye++){const Ce=de[ye];to(m,A,Ce,Ce.viewport)}}else V.length>0&&ma(q,V,A,H),Oe&&Ae.render(A),to(m,A,H);R!==null&&(E.updateMultisampleRenderTarget(R),E.updateRenderTargetMipmap(R)),A.isScene===!0&&A.onAfterRender(y,A,H),tt.resetDefaultState(),T=-1,w=null,v.pop(),v.length>0?(u=v[v.length-1],ie===!0&&ce.setGlobalState(y.clippingPlanes,u.state.camera)):u=null,_.pop(),_.length>0?m=_[_.length-1]:m=null};function eo(A,H,$,q){if(A.visible===!1)return;if(A.layers.test(H.layers)){if(A.isGroup)$=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(H);else if(A.isLight)u.pushLight(A),A.castShadow&&u.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Y.intersectsSprite(A)){q&&Be.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Le);const ye=ne.update(A),be=A.material;be.visible&&m.push(A,ye,be,$,Be.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Y.intersectsObject(A))){const ye=ne.update(A),be=A.material;if(q&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Be.copy(A.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),Be.copy(ye.boundingSphere.center)),Be.applyMatrix4(A.matrixWorld).applyMatrix4(Le)),Array.isArray(be)){const Ce=ye.groups;for(let Fe=0,He=Ce.length;Fe<He;Fe++){const Re=Ce[Fe],Qe=be[Re.materialIndex];Qe&&Qe.visible&&m.push(A,ye,Qe,$,Be.z,Re)}}else be.visible&&m.push(A,ye,be,$,Be.z,null)}}const de=A.children;for(let ye=0,be=de.length;ye<be;ye++)eo(de[ye],H,$,q)}function to(A,H,$,q){const V=A.opaque,de=A.transmissive,ye=A.transparent;u.setupLightsView($),ie===!0&&ce.setGlobalState(y.clippingPlanes,$),q&&O.viewport(L.copy(q)),V.length>0&&st(V,H,$),de.length>0&&st(de,H,$),ye.length>0&&st(ye,H,$),O.buffers.depth.setTest(!0),O.buffers.depth.setMask(!0),O.buffers.color.setMask(!0),O.setPolygonOffset(!1)}function ma(A,H,$,q){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[q.id]===void 0&&(u.state.transmissionRenderTarget[q.id]=new kr(1,1,{generateMipmaps:!0,type:Ue.has("EXT_color_buffer_half_float")||Ue.has("EXT_color_buffer_float")?ua:Pi,minFilter:Rr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace}));const de=u.state.transmissionRenderTarget[q.id],ye=q.viewport||L;de.setSize(ye.z,ye.w);const be=y.getRenderTarget();y.setRenderTarget(de),y.getClearColor(j),Z=y.getClearAlpha(),Z<1&&y.setClearColor(16777215,.5),y.clear(),Oe&&Ae.render($);const Ce=y.toneMapping;y.toneMapping=rr;const Fe=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),u.setupLightsView(q),ie===!0&&ce.setGlobalState(y.clippingPlanes,q),st(A,$,q),E.updateMultisampleRenderTarget(de),E.updateRenderTargetMipmap(de),Ue.has("WEBGL_multisampled_render_to_texture")===!1){let He=!1;for(let Re=0,Qe=H.length;Re<Qe;Re++){const ut=H[Re],mt=ut.object,an=ut.geometry,nt=ut.material,Pe=ut.group;if(nt.side===vi&&mt.layers.test(q.layers)){const li=nt.side;nt.side=pn,nt.needsUpdate=!0,Rf(mt,$,q,an,nt,Pe),nt.side=li,nt.needsUpdate=!0,He=!0}}He===!0&&(E.updateMultisampleRenderTarget(de),E.updateRenderTargetMipmap(de))}y.setRenderTarget(be),y.setClearColor(j,Z),Fe!==void 0&&(q.viewport=Fe),y.toneMapping=Ce}function st(A,H,$){const q=H.isScene===!0?H.overrideMaterial:null;for(let V=0,de=A.length;V<de;V++){const ye=A[V],be=ye.object,Ce=ye.geometry,Fe=q===null?ye.material:q,He=ye.group;be.layers.test($.layers)&&Rf(be,H,$,Ce,Fe,He)}}function Rf(A,H,$,q,V,de){A.onBeforeRender(y,H,$,q,V,de),A.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),V.onBeforeRender(y,H,$,q,A,de),V.transparent===!0&&V.side===vi&&V.forceSinglePass===!1?(V.side=pn,V.needsUpdate=!0,y.renderBufferDirect($,H,q,V,A,de),V.side=lr,V.needsUpdate=!0,y.renderBufferDirect($,H,q,V,A,de),V.side=vi):y.renderBufferDirect($,H,q,V,A,de),A.onAfterRender(y,H,$,q,V,de)}function ga(A,H,$){H.isScene!==!0&&(H=Xe);const q=G.get(A),V=u.state.lights,de=u.state.shadowsArray,ye=V.state.version,be=Te.getParameters(A,V.state,de,H,$),Ce=Te.getProgramCacheKey(be);let Fe=q.programs;q.environment=A.isMeshStandardMaterial?H.environment:null,q.fog=H.fog,q.envMap=(A.isMeshStandardMaterial?I:x).get(A.envMap||q.environment),q.envMapRotation=q.environment!==null&&A.envMap===null?H.environmentRotation:A.envMapRotation,Fe===void 0&&(A.addEventListener("dispose",ze),Fe=new Map,q.programs=Fe);let He=Fe.get(Ce);if(He!==void 0){if(q.currentProgram===He&&q.lightsStateVersion===ye)return Lf(A,be),He}else be.uniforms=Te.getUniforms(A),A.onBeforeCompile(be,y),He=Te.acquireProgram(be,Ce),Fe.set(Ce,He),q.uniforms=be.uniforms;const Re=q.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Re.clippingPlanes=ce.uniform),Lf(A,be),q.needsLights=lv(A),q.lightsStateVersion=ye,q.needsLights&&(Re.ambientLightColor.value=V.state.ambient,Re.lightProbe.value=V.state.probe,Re.directionalLights.value=V.state.directional,Re.directionalLightShadows.value=V.state.directionalShadow,Re.spotLights.value=V.state.spot,Re.spotLightShadows.value=V.state.spotShadow,Re.rectAreaLights.value=V.state.rectArea,Re.ltc_1.value=V.state.rectAreaLTC1,Re.ltc_2.value=V.state.rectAreaLTC2,Re.pointLights.value=V.state.point,Re.pointLightShadows.value=V.state.pointShadow,Re.hemisphereLights.value=V.state.hemi,Re.directionalShadowMap.value=V.state.directionalShadowMap,Re.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Re.spotShadowMap.value=V.state.spotShadowMap,Re.spotLightMatrix.value=V.state.spotLightMatrix,Re.spotLightMap.value=V.state.spotLightMap,Re.pointShadowMap.value=V.state.pointShadowMap,Re.pointShadowMatrix.value=V.state.pointShadowMatrix),q.currentProgram=He,q.uniformsList=null,He}function Pf(A){if(A.uniformsList===null){const H=A.currentProgram.getUniforms();A.uniformsList=Rl.seqWithValue(H.seq,A.uniforms)}return A.uniformsList}function Lf(A,H){const $=G.get(A);$.outputColorSpace=H.outputColorSpace,$.batching=H.batching,$.batchingColor=H.batchingColor,$.instancing=H.instancing,$.instancingColor=H.instancingColor,$.instancingMorph=H.instancingMorph,$.skinning=H.skinning,$.morphTargets=H.morphTargets,$.morphNormals=H.morphNormals,$.morphColors=H.morphColors,$.morphTargetsCount=H.morphTargetsCount,$.numClippingPlanes=H.numClippingPlanes,$.numIntersection=H.numClipIntersection,$.vertexAlphas=H.vertexAlphas,$.vertexTangents=H.vertexTangents,$.toneMapping=H.toneMapping}function ov(A,H,$,q,V){H.isScene!==!0&&(H=Xe),E.resetTextureUnits();const de=H.fog,ye=q.isMeshStandardMaterial?H.environment:null,be=R===null?y.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Js,Ce=(q.isMeshStandardMaterial?I:x).get(q.envMap||ye),Fe=q.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,He=!!$.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Re=!!$.morphAttributes.position,Qe=!!$.morphAttributes.normal,ut=!!$.morphAttributes.color;let mt=rr;q.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(mt=y.toneMapping);const an=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,nt=an!==void 0?an.length:0,Pe=G.get(q),li=u.state.lights;if(ie===!0&&(he===!0||A!==w)){const Tn=A===w&&q.id===T;ce.setState(q,A,Tn)}let it=!1;q.version===Pe.__version?(Pe.needsLights&&Pe.lightsStateVersion!==li.state.version||Pe.outputColorSpace!==be||V.isBatchedMesh&&Pe.batching===!1||!V.isBatchedMesh&&Pe.batching===!0||V.isBatchedMesh&&Pe.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&Pe.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&Pe.instancing===!1||!V.isInstancedMesh&&Pe.instancing===!0||V.isSkinnedMesh&&Pe.skinning===!1||!V.isSkinnedMesh&&Pe.skinning===!0||V.isInstancedMesh&&Pe.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Pe.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Pe.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Pe.instancingMorph===!1&&V.morphTexture!==null||Pe.envMap!==Ce||q.fog===!0&&Pe.fog!==de||Pe.numClippingPlanes!==void 0&&(Pe.numClippingPlanes!==ce.numPlanes||Pe.numIntersection!==ce.numIntersection)||Pe.vertexAlphas!==Fe||Pe.vertexTangents!==He||Pe.morphTargets!==Re||Pe.morphNormals!==Qe||Pe.morphColors!==ut||Pe.toneMapping!==mt||Pe.morphTargetsCount!==nt)&&(it=!0):(it=!0,Pe.__version=q.version);let kn=Pe.currentProgram;it===!0&&(kn=ga(q,H,V));let Wr=!1,mn=!1,no=!1;const gt=kn.getUniforms(),Jn=Pe.uniforms;if(O.useProgram(kn.program)&&(Wr=!0,mn=!0,no=!0),q.id!==T&&(T=q.id,mn=!0),Wr||w!==A){O.buffers.depth.getReversed()?(se.copy(A.projectionMatrix),NS(se),IS(se),gt.setValue(B,"projectionMatrix",se)):gt.setValue(B,"projectionMatrix",A.projectionMatrix),gt.setValue(B,"viewMatrix",A.matrixWorldInverse);const Ni=gt.map.cameraPosition;Ni!==void 0&&Ni.setValue(B,Ne.setFromMatrixPosition(A.matrixWorld)),Ge.logarithmicDepthBuffer&&gt.setValue(B,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&gt.setValue(B,"isOrthographic",A.isOrthographicCamera===!0),w!==A&&(w=A,mn=!0,no=!0)}if(V.isSkinnedMesh){gt.setOptional(B,V,"bindMatrix"),gt.setOptional(B,V,"bindMatrixInverse");const Tn=V.skeleton;Tn&&(Tn.boneTexture===null&&Tn.computeBoneTexture(),gt.setValue(B,"boneTexture",Tn.boneTexture,E))}V.isBatchedMesh&&(gt.setOptional(B,V,"batchingTexture"),gt.setValue(B,"batchingTexture",V._matricesTexture,E),gt.setOptional(B,V,"batchingIdTexture"),gt.setValue(B,"batchingIdTexture",V._indirectTexture,E),gt.setOptional(B,V,"batchingColorTexture"),V._colorsTexture!==null&&gt.setValue(B,"batchingColorTexture",V._colorsTexture,E));const io=$.morphAttributes;if((io.position!==void 0||io.normal!==void 0||io.color!==void 0)&&Ie.update(V,$,kn),(mn||Pe.receiveShadow!==V.receiveShadow)&&(Pe.receiveShadow=V.receiveShadow,gt.setValue(B,"receiveShadow",V.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(Jn.envMap.value=Ce,Jn.flipEnvMap.value=Ce.isCubeTexture&&Ce.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&H.environment!==null&&(Jn.envMapIntensity.value=H.environmentIntensity),mn&&(gt.setValue(B,"toneMappingExposure",y.toneMappingExposure),Pe.needsLights&&av(Jn,no),de&&q.fog===!0&&me.refreshFogUniforms(Jn,de),me.refreshMaterialUniforms(Jn,q,D,ee,u.state.transmissionRenderTarget[A.id]),Rl.upload(B,Pf(Pe),Jn,E)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Rl.upload(B,Pf(Pe),Jn,E),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&gt.setValue(B,"center",V.center),gt.setValue(B,"modelViewMatrix",V.modelViewMatrix),gt.setValue(B,"normalMatrix",V.normalMatrix),gt.setValue(B,"modelMatrix",V.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const Tn=q.uniformsGroups;for(let Ni=0,Ii=Tn.length;Ni<Ii;Ni++){const Df=Tn[Ni];k.update(Df,kn),k.bind(Df,kn)}}return kn}function av(A,H){A.ambientLightColor.needsUpdate=H,A.lightProbe.needsUpdate=H,A.directionalLights.needsUpdate=H,A.directionalLightShadows.needsUpdate=H,A.pointLights.needsUpdate=H,A.pointLightShadows.needsUpdate=H,A.spotLights.needsUpdate=H,A.spotLightShadows.needsUpdate=H,A.rectAreaLights.needsUpdate=H,A.hemisphereLights.needsUpdate=H}function lv(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(A,H,$){G.get(A.texture).__webglTexture=H,G.get(A.depthTexture).__webglTexture=$;const q=G.get(A);q.__hasExternalTextures=!0,q.__autoAllocateDepthBuffer=$===void 0,q.__autoAllocateDepthBuffer||Ue.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,H){const $=G.get(A);$.__webglFramebuffer=H,$.__useDefaultFramebuffer=H===void 0},this.setRenderTarget=function(A,H=0,$=0){R=A,C=H,b=$;let q=!0,V=null,de=!1,ye=!1;if(A){const Ce=G.get(A);if(Ce.__useDefaultFramebuffer!==void 0)O.bindFramebuffer(B.FRAMEBUFFER,null),q=!1;else if(Ce.__webglFramebuffer===void 0)E.setupRenderTarget(A);else if(Ce.__hasExternalTextures)E.rebindTextures(A,G.get(A.texture).__webglTexture,G.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Re=A.depthTexture;if(Ce.__boundDepthTexture!==Re){if(Re!==null&&G.has(Re)&&(A.width!==Re.image.width||A.height!==Re.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(A)}}const Fe=A.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(ye=!0);const He=G.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(He[H])?V=He[H][$]:V=He[H],de=!0):A.samples>0&&E.useMultisampledRTT(A)===!1?V=G.get(A).__webglMultisampledFramebuffer:Array.isArray(He)?V=He[$]:V=He,L.copy(A.viewport),z.copy(A.scissor),F=A.scissorTest}else L.copy(te).multiplyScalar(D).floor(),z.copy(ue).multiplyScalar(D).floor(),F=we;if(O.bindFramebuffer(B.FRAMEBUFFER,V)&&q&&O.drawBuffers(A,V),O.viewport(L),O.scissor(z),O.setScissorTest(F),de){const Ce=G.get(A.texture);B.framebufferTexture2D(B.FRAMEBUFFER,B.COLOR_ATTACHMENT0,B.TEXTURE_CUBE_MAP_POSITIVE_X+H,Ce.__webglTexture,$)}else if(ye){const Ce=G.get(A.texture),Fe=H||0;B.framebufferTextureLayer(B.FRAMEBUFFER,B.COLOR_ATTACHMENT0,Ce.__webglTexture,$||0,Fe)}T=-1},this.readRenderTargetPixels=function(A,H,$,q,V,de,ye){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let be=G.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&ye!==void 0&&(be=be[ye]),be){O.bindFramebuffer(B.FRAMEBUFFER,be);try{const Ce=A.texture,Fe=Ce.format,He=Ce.type;if(!Ge.textureFormatReadable(Fe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ge.textureTypeReadable(He)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=A.width-q&&$>=0&&$<=A.height-V&&B.readPixels(H,$,q,V,ke.convert(Fe),ke.convert(He),de)}finally{const Ce=R!==null?G.get(R).__webglFramebuffer:null;O.bindFramebuffer(B.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(A,H,$,q,V,de,ye){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let be=G.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&ye!==void 0&&(be=be[ye]),be){const Ce=A.texture,Fe=Ce.format,He=Ce.type;if(!Ge.textureFormatReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ge.textureTypeReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(H>=0&&H<=A.width-q&&$>=0&&$<=A.height-V){O.bindFramebuffer(B.FRAMEBUFFER,be);const Re=B.createBuffer();B.bindBuffer(B.PIXEL_PACK_BUFFER,Re),B.bufferData(B.PIXEL_PACK_BUFFER,de.byteLength,B.STREAM_READ),B.readPixels(H,$,q,V,ke.convert(Fe),ke.convert(He),0);const Qe=R!==null?G.get(R).__webglFramebuffer:null;O.bindFramebuffer(B.FRAMEBUFFER,Qe);const ut=B.fenceSync(B.SYNC_GPU_COMMANDS_COMPLETE,0);return B.flush(),await DS(B,ut,4),B.bindBuffer(B.PIXEL_PACK_BUFFER,Re),B.getBufferSubData(B.PIXEL_PACK_BUFFER,0,de),B.deleteBuffer(Re),B.deleteSync(ut),de}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,H=null,$=0){A.isTexture!==!0&&(bo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),H=arguments[0]||null,A=arguments[1]);const q=Math.pow(2,-$),V=Math.floor(A.image.width*q),de=Math.floor(A.image.height*q),ye=H!==null?H.x:0,be=H!==null?H.y:0;E.setTexture2D(A,0),B.copyTexSubImage2D(B.TEXTURE_2D,$,0,0,ye,be,V,de),O.unbindTexture()},this.copyTextureToTexture=function(A,H,$=null,q=null,V=0){A.isTexture!==!0&&(bo("WebGLRenderer: copyTextureToTexture function signature has changed."),q=arguments[0]||null,A=arguments[1],H=arguments[2],V=arguments[3]||0,$=null);let de,ye,be,Ce,Fe,He,Re,Qe,ut;const mt=A.isCompressedTexture?A.mipmaps[V]:A.image;$!==null?(de=$.max.x-$.min.x,ye=$.max.y-$.min.y,be=$.isBox3?$.max.z-$.min.z:1,Ce=$.min.x,Fe=$.min.y,He=$.isBox3?$.min.z:0):(de=mt.width,ye=mt.height,be=mt.depth||1,Ce=0,Fe=0,He=0),q!==null?(Re=q.x,Qe=q.y,ut=q.z):(Re=0,Qe=0,ut=0);const an=ke.convert(H.format),nt=ke.convert(H.type);let Pe;H.isData3DTexture?(E.setTexture3D(H,0),Pe=B.TEXTURE_3D):H.isDataArrayTexture||H.isCompressedArrayTexture?(E.setTexture2DArray(H,0),Pe=B.TEXTURE_2D_ARRAY):(E.setTexture2D(H,0),Pe=B.TEXTURE_2D),B.pixelStorei(B.UNPACK_FLIP_Y_WEBGL,H.flipY),B.pixelStorei(B.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),B.pixelStorei(B.UNPACK_ALIGNMENT,H.unpackAlignment);const li=B.getParameter(B.UNPACK_ROW_LENGTH),it=B.getParameter(B.UNPACK_IMAGE_HEIGHT),kn=B.getParameter(B.UNPACK_SKIP_PIXELS),Wr=B.getParameter(B.UNPACK_SKIP_ROWS),mn=B.getParameter(B.UNPACK_SKIP_IMAGES);B.pixelStorei(B.UNPACK_ROW_LENGTH,mt.width),B.pixelStorei(B.UNPACK_IMAGE_HEIGHT,mt.height),B.pixelStorei(B.UNPACK_SKIP_PIXELS,Ce),B.pixelStorei(B.UNPACK_SKIP_ROWS,Fe),B.pixelStorei(B.UNPACK_SKIP_IMAGES,He);const no=A.isDataArrayTexture||A.isData3DTexture,gt=H.isDataArrayTexture||H.isData3DTexture;if(A.isRenderTargetTexture||A.isDepthTexture){const Jn=G.get(A),io=G.get(H),Tn=G.get(Jn.__renderTarget),Ni=G.get(io.__renderTarget);O.bindFramebuffer(B.READ_FRAMEBUFFER,Tn.__webglFramebuffer),O.bindFramebuffer(B.DRAW_FRAMEBUFFER,Ni.__webglFramebuffer);for(let Ii=0;Ii<be;Ii++)no&&B.framebufferTextureLayer(B.READ_FRAMEBUFFER,B.COLOR_ATTACHMENT0,G.get(A).__webglTexture,V,He+Ii),A.isDepthTexture?(gt&&B.framebufferTextureLayer(B.DRAW_FRAMEBUFFER,B.COLOR_ATTACHMENT0,G.get(H).__webglTexture,V,ut+Ii),B.blitFramebuffer(Ce,Fe,de,ye,Re,Qe,de,ye,B.DEPTH_BUFFER_BIT,B.NEAREST)):gt?B.copyTexSubImage3D(Pe,V,Re,Qe,ut+Ii,Ce,Fe,de,ye):B.copyTexSubImage2D(Pe,V,Re,Qe,ut+Ii,Ce,Fe,de,ye);O.bindFramebuffer(B.READ_FRAMEBUFFER,null),O.bindFramebuffer(B.DRAW_FRAMEBUFFER,null)}else gt?A.isDataTexture||A.isData3DTexture?B.texSubImage3D(Pe,V,Re,Qe,ut,de,ye,be,an,nt,mt.data):H.isCompressedArrayTexture?B.compressedTexSubImage3D(Pe,V,Re,Qe,ut,de,ye,be,an,mt.data):B.texSubImage3D(Pe,V,Re,Qe,ut,de,ye,be,an,nt,mt):A.isDataTexture?B.texSubImage2D(B.TEXTURE_2D,V,Re,Qe,de,ye,an,nt,mt.data):A.isCompressedTexture?B.compressedTexSubImage2D(B.TEXTURE_2D,V,Re,Qe,mt.width,mt.height,an,mt.data):B.texSubImage2D(B.TEXTURE_2D,V,Re,Qe,de,ye,an,nt,mt);B.pixelStorei(B.UNPACK_ROW_LENGTH,li),B.pixelStorei(B.UNPACK_IMAGE_HEIGHT,it),B.pixelStorei(B.UNPACK_SKIP_PIXELS,kn),B.pixelStorei(B.UNPACK_SKIP_ROWS,Wr),B.pixelStorei(B.UNPACK_SKIP_IMAGES,mn),V===0&&H.generateMipmaps&&B.generateMipmap(Pe),O.unbindTexture()},this.copyTextureToTexture3D=function(A,H,$=null,q=null,V=0){return A.isTexture!==!0&&(bo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),$=arguments[0]||null,q=arguments[1]||null,A=arguments[2],H=arguments[3],V=arguments[4]||0),bo('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(A,H,$,q,V)},this.initRenderTarget=function(A){G.get(A).__webglFramebuffer===void 0&&E.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?E.setTextureCube(A,0):A.isData3DTexture?E.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?E.setTexture2DArray(A,0):E.setTexture2D(A,0),O.unbindTexture()},this.resetState=function(){C=0,b=0,R=null,O.reset(),tt.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Mi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorspace=Ze._getDrawingBufferColorSpace(e),n.unpackColorSpace=Ze._getUnpackColorSpace()}}class WT extends Nt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ai,this.environmentIntensity=1,this.environmentRotation=new ai,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class jT{constructor(e,n){this.isInterleavedBuffer=!0,this.array=e,this.stride=n,this.count=e!==void 0?e.length/n:0,this.usage=ph,this.updateRanges=[],this.version=0,this.uuid=sr()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}setUsage(e){return this.usage=e,this}addUpdateRange(e,n){this.updateRanges.push({start:e,count:n})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,n,i){e*=this.stride,i*=n.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=n.array[i+r];return this}set(e,n=0){return this.array.set(e,n),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=sr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const n=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(n,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=sr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Jt=new N;class nc{constructor(e,n,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=n,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let n=0,i=this.data.count;n<i;n++)Jt.fromBufferAttribute(this,n),Jt.applyMatrix4(e),this.setXYZ(n,Jt.x,Jt.y,Jt.z);return this}applyNormalMatrix(e){for(let n=0,i=this.count;n<i;n++)Jt.fromBufferAttribute(this,n),Jt.applyNormalMatrix(e),this.setXYZ(n,Jt.x,Jt.y,Jt.z);return this}transformDirection(e){for(let n=0,i=this.count;n<i;n++)Jt.fromBufferAttribute(this,n),Jt.transformDirection(e),this.setXYZ(n,Jt.x,Jt.y,Jt.z);return this}getComponent(e,n){let i=this.array[e*this.data.stride+this.offset+n];return this.normalized&&(i=ii(i,this.array)),i}setComponent(e,n,i){return this.normalized&&(i=at(i,this.array)),this.data.array[e*this.data.stride+this.offset+n]=i,this}setX(e,n){return this.normalized&&(n=at(n,this.array)),this.data.array[e*this.data.stride+this.offset]=n,this}setY(e,n){return this.normalized&&(n=at(n,this.array)),this.data.array[e*this.data.stride+this.offset+1]=n,this}setZ(e,n){return this.normalized&&(n=at(n,this.array)),this.data.array[e*this.data.stride+this.offset+2]=n,this}setW(e,n){return this.normalized&&(n=at(n,this.array)),this.data.array[e*this.data.stride+this.offset+3]=n,this}getX(e){let n=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(n=ii(n,this.array)),n}getY(e){let n=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(n=ii(n,this.array)),n}getZ(e){let n=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(n=ii(n,this.array)),n}getW(e){let n=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(n=ii(n,this.array)),n}setXY(e,n,i){return e=e*this.data.stride+this.offset,this.normalized&&(n=at(n,this.array),i=at(i,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this}setXYZ(e,n,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(n=at(n,this.array),i=at(i,this.array),r=at(r,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,n,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(n=at(n,this.array),i=at(i,this.array),r=at(r,this.array),s=at(s,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return new Un(new this.array.constructor(n),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new nc(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:n,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class K0 extends fr{static get type(){return"SpriteMaterial"}constructor(e){super(),this.isSpriteMaterial=!0,this.color=new Ye(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let as;const vo=new N,ls=new N,cs=new N,us=new xe,yo=new xe,Z0=new ct,nl=new N,xo=new N,il=new N,km=new xe,Cu=new xe,zm=new xe;class XT extends Nt{constructor(e=new K0){if(super(),this.isSprite=!0,this.type="Sprite",as===void 0){as=new Wt;const n=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new jT(n,5);as.setIndex([0,1,2,0,2,3]),as.setAttribute("position",new nc(i,3,0,!1)),as.setAttribute("uv",new nc(i,2,3,!1))}this.geometry=as,this.material=e,this.center=new xe(.5,.5)}raycast(e,n){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),ls.setFromMatrixScale(this.matrixWorld),Z0.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),cs.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&ls.multiplyScalar(-cs.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const o=this.center;rl(nl.set(-.5,-.5,0),cs,o,ls,r,s),rl(xo.set(.5,-.5,0),cs,o,ls,r,s),rl(il.set(.5,.5,0),cs,o,ls,r,s),km.set(0,0),Cu.set(1,0),zm.set(1,1);let a=e.ray.intersectTriangle(nl,xo,il,!1,vo);if(a===null&&(rl(xo.set(-.5,.5,0),cs,o,ls,r,s),Cu.set(0,1),a=e.ray.intersectTriangle(nl,il,xo,!1,vo),a===null))return;const l=e.ray.origin.distanceTo(vo);l<e.near||l>e.far||n.push({distance:l,point:vo.clone(),uv:Dn.getInterpolation(vo,nl,xo,il,km,Cu,zm,new xe),face:null,object:this})}copy(e,n){return super.copy(e,n),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function rl(t,e,n,i,r,s){us.subVectors(t,n).addScalar(.5).multiply(i),r!==void 0?(yo.x=s*us.x-r*us.y,yo.y=r*us.x+s*us.y):yo.copy(us),t.copy(e),t.x+=yo.x,t.y+=yo.y,t.applyMatrix4(Z0)}class J0 extends fr{static get type(){return"LineBasicMaterial"}constructor(e){super(),this.isLineBasicMaterial=!0,this.color=new Ye(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const ic=new N,rc=new N,Bm=new ct,So=new ha,sl=new da,Ru=new N,Hm=new N;class YT extends Nt{constructor(e=new Wt,n=new J0){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[0];for(let r=1,s=n.count;r<s;r++)ic.fromBufferAttribute(n,r-1),rc.fromBufferAttribute(n,r),i[r]=i[r-1],i[r]+=ic.distanceTo(rc);e.setAttribute("lineDistance",new ft(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),sl.copy(i.boundingSphere),sl.applyMatrix4(r),sl.radius+=s,e.ray.intersectsSphere(sl)===!1)return;Bm.copy(r).invert(),So.copy(e.ray).applyMatrix4(Bm);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=this.isLineSegments?2:1,d=i.index,h=i.attributes.position;if(d!==null){const p=Math.max(0,o.start),g=Math.min(d.count,o.start+o.count);for(let S=p,m=g-1;S<m;S+=c){const u=d.getX(S),_=d.getX(S+1),v=ol(this,e,So,l,u,_);v&&n.push(v)}if(this.isLineLoop){const S=d.getX(g-1),m=d.getX(p),u=ol(this,e,So,l,S,m);u&&n.push(u)}}else{const p=Math.max(0,o.start),g=Math.min(h.count,o.start+o.count);for(let S=p,m=g-1;S<m;S+=c){const u=ol(this,e,So,l,S,S+1);u&&n.push(u)}if(this.isLineLoop){const S=ol(this,e,So,l,g-1,p);S&&n.push(S)}}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function ol(t,e,n,i,r,s){const o=t.geometry.attributes.position;if(ic.fromBufferAttribute(o,r),rc.fromBufferAttribute(o,s),n.distanceSqToSegment(ic,rc,Ru,Hm)>i)return;Ru.applyMatrix4(t.matrixWorld);const l=e.ray.origin.distanceTo(Ru);if(!(l<e.near||l>e.far))return{distance:l,point:Hm.clone().applyMatrix4(t.matrixWorld),index:r,face:null,faceIndex:null,barycoord:null,object:t}}const Vm=new N,Gm=new N;class $T extends YT{constructor(e,n){super(e,n),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[];for(let r=0,s=n.count;r<s;r+=2)Vm.fromBufferAttribute(n,r),Gm.fromBufferAttribute(n,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+Vm.distanceTo(Gm);e.setAttribute("lineDistance",new ft(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class Q0 extends fr{static get type(){return"PointsMaterial"}constructor(e){super(),this.isPointsMaterial=!0,this.color=new Ye(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Wm=new ct,_h=new ha,al=new da,ll=new N;class qT extends Nt{constructor(e=new Wt,n=new Q0){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),al.copy(i.boundingSphere),al.applyMatrix4(r),al.radius+=s,e.ray.intersectsSphere(al)===!1)return;Wm.copy(r).invert(),_h.copy(e.ray).applyMatrix4(Wm);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=i.index,f=i.attributes.position;if(c!==null){const h=Math.max(0,o.start),p=Math.min(c.count,o.start+o.count);for(let g=h,S=p;g<S;g++){const m=c.getX(g);ll.fromBufferAttribute(f,m),jm(ll,m,l,r,e,n,this)}}else{const h=Math.max(0,o.start),p=Math.min(f.count,o.start+o.count);for(let g=h,S=p;g<S;g++)ll.fromBufferAttribute(f,g),jm(ll,g,l,r,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function jm(t,e,n,i,r,s,o){const a=_h.distanceSqToPoint(t);if(a<n){const l=new N;_h.closestPointToPoint(t,l),l.applyMatrix4(i);const c=r.ray.origin.distanceTo(l);if(c<r.near||c>r.far)return;s.push({distance:c,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,faceIndex:null,barycoord:null,object:o})}}class KT extends nn{constructor(e,n,i,r,s,o,a,l,c){super(e,n,i,r,s,o,a,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Di{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,n){const i=this.getUtoTmapping(e);return this.getPoint(i,n)}getPoints(e=5){const n=[];for(let i=0;i<=e;i++)n.push(this.getPoint(i/e));return n}getSpacedPoints(e=5){const n=[];for(let i=0;i<=e;i++)n.push(this.getPointAt(i/e));return n}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const n=[];let i,r=this.getPoint(0),s=0;n.push(0);for(let o=1;o<=e;o++)i=this.getPoint(o/e),s+=i.distanceTo(r),n.push(s),r=i;return this.cacheArcLengths=n,n}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,n){const i=this.getLengths();let r=0;const s=i.length;let o;n?o=n:o=e*i[s-1];let a=0,l=s-1,c;for(;a<=l;)if(r=Math.floor(a+(l-a)/2),c=i[r]-o,c<0)a=r+1;else if(c>0)l=r-1;else{l=r;break}if(r=l,i[r]===o)return r/(s-1);const d=i[r],h=i[r+1]-d,p=(o-d)/h;return(r+p)/(s-1)}getTangent(e,n){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const o=this.getPoint(r),a=this.getPoint(s),l=n||(o.isVector2?new xe:new N);return l.copy(a).sub(o).normalize(),l}getTangentAt(e,n){const i=this.getUtoTmapping(e);return this.getTangent(i,n)}computeFrenetFrames(e,n){const i=new N,r=[],s=[],o=[],a=new N,l=new ct;for(let p=0;p<=e;p++){const g=p/e;r[p]=this.getTangentAt(g,new N)}s[0]=new N,o[0]=new N;let c=Number.MAX_VALUE;const d=Math.abs(r[0].x),f=Math.abs(r[0].y),h=Math.abs(r[0].z);d<=c&&(c=d,i.set(1,0,0)),f<=c&&(c=f,i.set(0,1,0)),h<=c&&i.set(0,0,1),a.crossVectors(r[0],i).normalize(),s[0].crossVectors(r[0],a),o[0].crossVectors(r[0],s[0]);for(let p=1;p<=e;p++){if(s[p]=s[p-1].clone(),o[p]=o[p-1].clone(),a.crossVectors(r[p-1],r[p]),a.length()>Number.EPSILON){a.normalize();const g=Math.acos(Ht(r[p-1].dot(r[p]),-1,1));s[p].applyMatrix4(l.makeRotationAxis(a,g))}o[p].crossVectors(r[p],s[p])}if(n===!0){let p=Math.acos(Ht(s[0].dot(s[e]),-1,1));p/=e,r[0].dot(a.crossVectors(s[0],s[e]))>0&&(p=-p);for(let g=1;g<=e;g++)s[g].applyMatrix4(l.makeRotationAxis(r[g],p*g)),o[g].crossVectors(r[g],s[g])}return{tangents:r,normals:s,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class ev extends Di{constructor(e=0,n=0,i=1,r=1,s=0,o=Math.PI*2,a=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=n,this.xRadius=i,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=o,this.aClockwise=a,this.aRotation=l}getPoint(e,n=new xe){const i=n,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const o=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(o?s=0:s=r),this.aClockwise===!0&&!o&&(s===r?s=-r:s=s-r);const a=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(a),c=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const d=Math.cos(this.aRotation),f=Math.sin(this.aRotation),h=l-this.aX,p=c-this.aY;l=h*d-p*f+this.aX,c=h*f+p*d+this.aY}return i.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class ZT extends ev{constructor(e,n,i,r,s,o){super(e,n,i,i,r,s,o),this.isArcCurve=!0,this.type="ArcCurve"}}function wf(){let t=0,e=0,n=0,i=0;function r(s,o,a,l){t=s,e=a,n=-3*s+3*o-2*a-l,i=2*s-2*o+a+l}return{initCatmullRom:function(s,o,a,l,c){r(o,a,c*(a-s),c*(l-o))},initNonuniformCatmullRom:function(s,o,a,l,c,d,f){let h=(o-s)/c-(a-s)/(c+d)+(a-o)/d,p=(a-o)/d-(l-o)/(d+f)+(l-a)/f;h*=d,p*=d,r(o,a,h,p)},calc:function(s){const o=s*s,a=o*s;return t+e*s+n*o+i*a}}}const cl=new N,Pu=new wf,Lu=new wf,Du=new wf;class JT extends Di{constructor(e=[],n=!1,i="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=n,this.curveType=i,this.tension=r}getPoint(e,n=new N){const i=n,r=this.points,s=r.length,o=(s-(this.closed?0:1))*e;let a=Math.floor(o),l=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/s)+1)*s:l===0&&a===s-1&&(a=s-2,l=1);let c,d;this.closed||a>0?c=r[(a-1)%s]:(cl.subVectors(r[0],r[1]).add(r[0]),c=cl);const f=r[a%s],h=r[(a+1)%s];if(this.closed||a+2<s?d=r[(a+2)%s]:(cl.subVectors(r[s-1],r[s-2]).add(r[s-1]),d=cl),this.curveType==="centripetal"||this.curveType==="chordal"){const p=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(f),p),S=Math.pow(f.distanceToSquared(h),p),m=Math.pow(h.distanceToSquared(d),p);S<1e-4&&(S=1),g<1e-4&&(g=S),m<1e-4&&(m=S),Pu.initNonuniformCatmullRom(c.x,f.x,h.x,d.x,g,S,m),Lu.initNonuniformCatmullRom(c.y,f.y,h.y,d.y,g,S,m),Du.initNonuniformCatmullRom(c.z,f.z,h.z,d.z,g,S,m)}else this.curveType==="catmullrom"&&(Pu.initCatmullRom(c.x,f.x,h.x,d.x,this.tension),Lu.initCatmullRom(c.y,f.y,h.y,d.y,this.tension),Du.initCatmullRom(c.z,f.z,h.z,d.z,this.tension));return i.set(Pu.calc(l),Lu.calc(l),Du.calc(l)),i}copy(e){super.copy(e),this.points=[];for(let n=0,i=e.points.length;n<i;n++){const r=e.points[n];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let n=0,i=this.points.length;n<i;n++){const r=this.points[n];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let n=0,i=e.points.length;n<i;n++){const r=e.points[n];this.points.push(new N().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Xm(t,e,n,i,r){const s=(i-e)*.5,o=(r-n)*.5,a=t*t,l=t*a;return(2*n-2*i+s+o)*l+(-3*n+3*i-2*s-o)*a+s*t+n}function QT(t,e){const n=1-t;return n*n*e}function eA(t,e){return 2*(1-t)*t*e}function tA(t,e){return t*t*e}function ko(t,e,n,i){return QT(t,e)+eA(t,n)+tA(t,i)}function nA(t,e){const n=1-t;return n*n*n*e}function iA(t,e){const n=1-t;return 3*n*n*t*e}function rA(t,e){return 3*(1-t)*t*t*e}function sA(t,e){return t*t*t*e}function zo(t,e,n,i,r){return nA(t,e)+iA(t,n)+rA(t,i)+sA(t,r)}class oA extends Di{constructor(e=new xe,n=new xe,i=new xe,r=new xe){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=n,this.v2=i,this.v3=r}getPoint(e,n=new xe){const i=n,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return i.set(zo(e,r.x,s.x,o.x,a.x),zo(e,r.y,s.y,o.y,a.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class aA extends Di{constructor(e=new N,n=new N,i=new N,r=new N){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=n,this.v2=i,this.v3=r}getPoint(e,n=new N){const i=n,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return i.set(zo(e,r.x,s.x,o.x,a.x),zo(e,r.y,s.y,o.y,a.y),zo(e,r.z,s.z,o.z,a.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class lA extends Di{constructor(e=new xe,n=new xe){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=n}getPoint(e,n=new xe){const i=n;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,n){return this.getPoint(e,n)}getTangent(e,n=new xe){return n.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,n){return this.getTangent(e,n)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class tv extends Di{constructor(e=new N,n=new N){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=n}getPoint(e,n=new N){const i=n;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,n){return this.getPoint(e,n)}getTangent(e,n=new N){return n.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,n){return this.getTangent(e,n)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class cA extends Di{constructor(e=new xe,n=new xe,i=new xe){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=n,this.v2=i}getPoint(e,n=new xe){const i=n,r=this.v0,s=this.v1,o=this.v2;return i.set(ko(e,r.x,s.x,o.x),ko(e,r.y,s.y,o.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class nv extends Di{constructor(e=new N,n=new N,i=new N){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=n,this.v2=i}getPoint(e,n=new N){const i=n,r=this.v0,s=this.v1,o=this.v2;return i.set(ko(e,r.x,s.x,o.x),ko(e,r.y,s.y,o.y),ko(e,r.z,s.z,o.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class uA extends Di{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,n=new xe){const i=n,r=this.points,s=(r.length-1)*e,o=Math.floor(s),a=s-o,l=r[o===0?o:o-1],c=r[o],d=r[o>r.length-2?r.length-1:o+1],f=r[o>r.length-3?r.length-1:o+2];return i.set(Xm(a,l.x,c.x,d.x,f.x),Xm(a,l.y,c.y,d.y,f.y)),i}copy(e){super.copy(e),this.points=[];for(let n=0,i=e.points.length;n<i;n++){const r=e.points[n];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let n=0,i=this.points.length;n<i;n++){const r=this.points[n];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let n=0,i=e.points.length;n<i;n++){const r=e.points[n];this.points.push(new xe().fromArray(r))}return this}}var dA=Object.freeze({__proto__:null,ArcCurve:ZT,CatmullRomCurve3:JT,CubicBezierCurve:oA,CubicBezierCurve3:aA,EllipseCurve:ev,LineCurve:lA,LineCurve3:tv,QuadraticBezierCurve:cA,QuadraticBezierCurve3:nv,SplineCurve:uA});class sc extends Wt{constructor(e=1,n=32,i=0,r=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:n,thetaStart:i,thetaLength:r},n=Math.max(3,n);const s=[],o=[],a=[],l=[],c=new N,d=new xe;o.push(0,0,0),a.push(0,0,1),l.push(.5,.5);for(let f=0,h=3;f<=n;f++,h+=3){const p=i+f/n*r;c.x=e*Math.cos(p),c.y=e*Math.sin(p),o.push(c.x,c.y,c.z),a.push(0,0,1),d.x=(o[h]/e+1)/2,d.y=(o[h+1]/e+1)/2,l.push(d.x,d.y)}for(let f=1;f<=n;f++)s.push(f,f+1,0);this.setIndex(s),this.setAttribute("position",new ft(o,3)),this.setAttribute("normal",new ft(a,3)),this.setAttribute("uv",new ft(l,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new sc(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class bn extends Wt{constructor(e=1,n=1,i=1,r=32,s=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:n,height:i,radialSegments:r,heightSegments:s,openEnded:o,thetaStart:a,thetaLength:l};const c=this;r=Math.floor(r),s=Math.floor(s);const d=[],f=[],h=[],p=[];let g=0;const S=[],m=i/2;let u=0;_(),o===!1&&(e>0&&v(!0),n>0&&v(!1)),this.setIndex(d),this.setAttribute("position",new ft(f,3)),this.setAttribute("normal",new ft(h,3)),this.setAttribute("uv",new ft(p,2));function _(){const y=new N,P=new N;let C=0;const b=(n-e)/i;for(let R=0;R<=s;R++){const T=[],w=R/s,L=w*(n-e)+e;for(let z=0;z<=r;z++){const F=z/r,j=F*l+a,Z=Math.sin(j),X=Math.cos(j);P.x=L*Z,P.y=-w*i+m,P.z=L*X,f.push(P.x,P.y,P.z),y.set(Z,b,X).normalize(),h.push(y.x,y.y,y.z),p.push(F,1-w),T.push(g++)}S.push(T)}for(let R=0;R<r;R++)for(let T=0;T<s;T++){const w=S[T][R],L=S[T+1][R],z=S[T+1][R+1],F=S[T][R+1];(e>0||T!==0)&&(d.push(w,L,F),C+=3),(n>0||T!==s-1)&&(d.push(L,z,F),C+=3)}c.addGroup(u,C,0),u+=C}function v(y){const P=g,C=new xe,b=new N;let R=0;const T=y===!0?e:n,w=y===!0?1:-1;for(let z=1;z<=r;z++)f.push(0,m*w,0),h.push(0,w,0),p.push(.5,.5),g++;const L=g;for(let z=0;z<=r;z++){const j=z/r*l+a,Z=Math.cos(j),X=Math.sin(j);b.x=T*X,b.y=m*w,b.z=T*Z,f.push(b.x,b.y,b.z),h.push(0,w,0),C.x=Z*.5+.5,C.y=X*.5*w+.5,p.push(C.x,C.y),g++}for(let z=0;z<r;z++){const F=P+z,j=L+z;y===!0?d.push(j,j+1,F):d.push(j+1,j,F),R+=3}c.addGroup(u,R,y===!0?1:2),u+=R}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new bn(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class oc extends bn{constructor(e=1,n=1,i=32,r=1,s=!1,o=0,a=Math.PI*2){super(0,e,n,i,r,s,o,a),this.type="ConeGeometry",this.parameters={radius:e,height:n,radialSegments:i,heightSegments:r,openEnded:s,thetaStart:o,thetaLength:a}}static fromJSON(e){return new oc(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Tf extends Wt{constructor(e=1,n=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},n=Math.max(3,Math.floor(n)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const d=[],f=new N,h=new N,p=[],g=[],S=[],m=[];for(let u=0;u<=i;u++){const _=[],v=u/i;let y=0;u===0&&o===0?y=.5/n:u===i&&l===Math.PI&&(y=-.5/n);for(let P=0;P<=n;P++){const C=P/n;f.x=-e*Math.cos(r+C*s)*Math.sin(o+v*a),f.y=e*Math.cos(o+v*a),f.z=e*Math.sin(r+C*s)*Math.sin(o+v*a),g.push(f.x,f.y,f.z),h.copy(f).normalize(),S.push(h.x,h.y,h.z),m.push(C+y,1-v),_.push(c++)}d.push(_)}for(let u=0;u<i;u++)for(let _=0;_<n;_++){const v=d[u][_+1],y=d[u][_],P=d[u+1][_],C=d[u+1][_+1];(u!==0||o>0)&&p.push(v,y,C),(u!==i-1||l<Math.PI)&&p.push(y,P,C)}this.setIndex(p),this.setAttribute("position",new ft(g,3)),this.setAttribute("normal",new ft(S,3)),this.setAttribute("uv",new ft(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Tf(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Bo extends Wt{constructor(e=1,n=.4,i=12,r=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:n,radialSegments:i,tubularSegments:r,arc:s},i=Math.floor(i),r=Math.floor(r);const o=[],a=[],l=[],c=[],d=new N,f=new N,h=new N;for(let p=0;p<=i;p++)for(let g=0;g<=r;g++){const S=g/r*s,m=p/i*Math.PI*2;f.x=(e+n*Math.cos(m))*Math.cos(S),f.y=(e+n*Math.cos(m))*Math.sin(S),f.z=n*Math.sin(m),a.push(f.x,f.y,f.z),d.x=e*Math.cos(S),d.y=e*Math.sin(S),h.subVectors(f,d).normalize(),l.push(h.x,h.y,h.z),c.push(g/r),c.push(p/i)}for(let p=1;p<=i;p++)for(let g=1;g<=r;g++){const S=(r+1)*p+g-1,m=(r+1)*(p-1)+g-1,u=(r+1)*(p-1)+g,_=(r+1)*p+g;o.push(S,m,_),o.push(m,u,_)}this.setIndex(o),this.setAttribute("position",new ft(a,3)),this.setAttribute("normal",new ft(l,3)),this.setAttribute("uv",new ft(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Bo(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class Af extends Wt{constructor(e=new nv(new N(-1,-1,0),new N(-1,1,0),new N(1,1,0)),n=64,i=1,r=8,s=!1){super(),this.type="TubeGeometry",this.parameters={path:e,tubularSegments:n,radius:i,radialSegments:r,closed:s};const o=e.computeFrenetFrames(n,s);this.tangents=o.tangents,this.normals=o.normals,this.binormals=o.binormals;const a=new N,l=new N,c=new xe;let d=new N;const f=[],h=[],p=[],g=[];S(),this.setIndex(g),this.setAttribute("position",new ft(f,3)),this.setAttribute("normal",new ft(h,3)),this.setAttribute("uv",new ft(p,2));function S(){for(let v=0;v<n;v++)m(v);m(s===!1?n:0),_(),u()}function m(v){d=e.getPointAt(v/n,d);const y=o.normals[v],P=o.binormals[v];for(let C=0;C<=r;C++){const b=C/r*Math.PI*2,R=Math.sin(b),T=-Math.cos(b);l.x=T*y.x+R*P.x,l.y=T*y.y+R*P.y,l.z=T*y.z+R*P.z,l.normalize(),h.push(l.x,l.y,l.z),a.x=d.x+i*l.x,a.y=d.y+i*l.y,a.z=d.z+i*l.z,f.push(a.x,a.y,a.z)}}function u(){for(let v=1;v<=n;v++)for(let y=1;y<=r;y++){const P=(r+1)*(v-1)+(y-1),C=(r+1)*v+(y-1),b=(r+1)*v+y,R=(r+1)*(v-1)+y;g.push(P,C,R),g.push(C,b,R)}}function _(){for(let v=0;v<=n;v++)for(let y=0;y<=r;y++)c.x=v/n,c.y=y/r,p.push(c.x,c.y)}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON();return e.path=this.parameters.path.toJSON(),e}static fromJSON(e){return new Af(new dA[e.path.type]().fromJSON(e.path),e.tubularSegments,e.radius,e.radialSegments,e.closed)}}class We extends fr{static get type(){return"MeshStandardMaterial"}constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.color=new Ye(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ye(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=L0,this.normalScale=new xe(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new ai,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class iv extends Nt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ye(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const Nu=new ct,Ym=new N,$m=new N;class hA{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new xe(512,512),this.map=null,this.mapPass=null,this.matrix=new ct,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Mf,this._frameExtents=new xe(1,1),this._viewportCount=1,this._viewports=[new Tt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;Ym.setFromMatrixPosition(e.matrixWorld),n.position.copy(Ym),$m.setFromMatrixPosition(e.target.matrixWorld),n.lookAt($m),n.updateMatrixWorld(),Nu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Nu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Nu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class fA extends hA{constructor(){super(new W0(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class qm extends iv{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Nt.DEFAULT_UP),this.updateMatrix(),this.target=new Nt,this.shadow=new fA}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class pA extends iv{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}const Km=new ct;class mA{constructor(e,n,i=0,r=1/0){this.ray=new ha(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new Sf,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return Km.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Km),this}intersectObject(e,n=!0,i=[]){return vh(e,this,i,n),i.sort(Zm),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)vh(e[r],this,i,n);return i.sort(Zm),i}}function Zm(t,e){return t.distance-e.distance}function vh(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let o=0,a=s.length;o<a;o++)vh(s[o],e,n,!0)}}class Jm{constructor(e=1,n=0,i=0){return this.radius=e,this.phi=n,this.theta=i,this}set(e,n,i){return this.radius=e,this.phi=n,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,n,i){return this.radius=Math.sqrt(e*e+n*n+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Ht(n/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}class gA extends $T{constructor(e=10,n=10,i=4473924,r=8947848){i=new Ye(i),r=new Ye(r);const s=n/2,o=e/n,a=e/2,l=[],c=[];for(let h=0,p=0,g=-a;h<=n;h++,g+=o){l.push(-a,0,g,a,0,g),l.push(g,0,-a,g,0,a);const S=h===s?i:r;S.toArray(c,p),p+=3,S.toArray(c,p),p+=3,S.toArray(c,p),p+=3,S.toArray(c,p),p+=3}const d=new Wt;d.setAttribute("position",new ft(l,3)),d.setAttribute("color",new ft(c,3));const f=new J0({vertexColors:!0,toneMapped:!1});super(d,f),this.type="GridHelper"}dispose(){this.geometry.dispose(),this.material.dispose()}}class _A extends Gr{constructor(e,n=null){super(),this.object=e,this.domElement=n,this.enabled=!0,this.state=-1,this.keys={},this.mouseButtons={LEFT:null,MIDDLE:null,RIGHT:null},this.touches={ONE:null,TWO:null}}connect(){}disconnect(){}dispose(){}update(){}}typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:pf}}));typeof window!="undefined"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=pf);const Qm={type:"change"},bf={type:"start"},rv={type:"end"},ul=new ha,eg=new _i,vA=Math.cos(70*PS.DEG2RAD),Pt=new N,ln=2*Math.PI,lt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Iu=1e-6;class yA extends _A{constructor(e,n=null){super(e,n),this.state=lt.NONE,this.enabled=!0,this.target=new N,this.cursor=new N,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ds.ROTATE,MIDDLE:Ds.DOLLY,RIGHT:Ds.PAN},this.touches={ONE:ws.ROTATE,TWO:ws.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new N,this._lastQuaternion=new zr,this._lastTargetPosition=new N,this._quat=new zr().setFromUnitVectors(e.up,new N(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Jm,this._sphericalDelta=new Jm,this._scale=1,this._panOffset=new N,this._rotateStart=new xe,this._rotateEnd=new xe,this._rotateDelta=new xe,this._panStart=new xe,this._panEnd=new xe,this._panDelta=new xe,this._dollyStart=new xe,this._dollyEnd=new xe,this._dollyDelta=new xe,this._dollyDirection=new N,this._mouse=new xe,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=SA.bind(this),this._onPointerDown=xA.bind(this),this._onPointerUp=MA.bind(this),this._onContextMenu=RA.bind(this),this._onMouseWheel=TA.bind(this),this._onKeyDown=AA.bind(this),this._onTouchStart=bA.bind(this),this._onTouchMove=CA.bind(this),this._onMouseDown=EA.bind(this),this._onMouseMove=wA.bind(this),this._interceptControlDown=PA.bind(this),this._interceptControlUp=LA.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Qm),this.update(),this.state=lt.NONE}update(e=null){const n=this.object.position;Pt.copy(n).sub(this.target),Pt.applyQuaternion(this._quat),this._spherical.setFromVector3(Pt),this.autoRotate&&this.state===lt.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=ln:i>Math.PI&&(i-=ln),r<-Math.PI?r+=ln:r>Math.PI&&(r-=ln),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=o!=this._spherical.radius}if(Pt.setFromSpherical(this._spherical),Pt.applyQuaternion(this._quatInverse),n.copy(this.target).add(Pt),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=Pt.length();o=this._clampDistance(a*this._scale);const l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const a=new N(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const c=new N(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(a),this.object.updateMatrixWorld(),o=Pt.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(ul.origin.copy(this.object.position),ul.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ul.direction))<vA?this.object.lookAt(this.target):(eg.setFromNormalAndCoplanarPoint(this.object.up,this.target),ul.intersectPlane(eg,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Iu||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Iu||this._lastTargetPosition.distanceToSquared(this.target)>Iu?(this.dispatchEvent(Qm),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?ln/60*this.autoRotateSpeed*e:ln/60/60*this.autoRotateSpeed}_getZoomScale(e){const n=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*n)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,n){Pt.setFromMatrixColumn(n,0),Pt.multiplyScalar(-e),this._panOffset.add(Pt)}_panUp(e,n){this.screenSpacePanning===!0?Pt.setFromMatrixColumn(n,1):(Pt.setFromMatrixColumn(n,0),Pt.crossVectors(this.object.up,Pt)),Pt.multiplyScalar(e),this._panOffset.add(Pt)}_pan(e,n){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;Pt.copy(r).sub(this.target);let s=Pt.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*s/i.clientHeight,this.object.matrix),this._panUp(2*n*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(n*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,n){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=e-i.left,s=n-i.top,o=i.width,a=i.height;this._mouse.x=r/o*2-1,this._mouse.y=-(s/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const n=this.domElement;this._rotateLeft(ln*this._rotateDelta.x/n.clientHeight),this._rotateUp(ln*this._rotateDelta.y/n.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let n=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this._rotateUp(ln*this.rotateSpeed/this.domElement.clientHeight):this._pan(0,this.keyPanSpeed),n=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this._rotateUp(-ln*this.rotateSpeed/this.domElement.clientHeight):this._pan(0,-this.keyPanSpeed),n=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this._rotateLeft(ln*this.rotateSpeed/this.domElement.clientHeight):this._pan(this.keyPanSpeed,0),n=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this._rotateLeft(-ln*this.rotateSpeed/this.domElement.clientHeight):this._pan(-this.keyPanSpeed,0),n=!0;break}n&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._panStart.set(i,r)}}_handleTouchStartDolly(e){const n=this._getSecondPointerPosition(e),i=e.pageX-n.x,r=e.pageY-n.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),r=.5*(e.pageX+i.x),s=.5*(e.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const n=this.domElement;this._rotateLeft(ln*this._rotateDelta.x/n.clientHeight),this._rotateUp(ln*this._rotateDelta.y/n.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),i=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const n=this._getSecondPointerPosition(e),i=e.pageX-n.x,r=e.pageY-n.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(e.pageX+n.x)*.5,a=(e.pageY+n.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let n=0;n<this._pointers.length;n++)if(this._pointers[n]==e.pointerId){this._pointers.splice(n,1);return}}_isTrackingPointer(e){for(let n=0;n<this._pointers.length;n++)if(this._pointers[n]==e.pointerId)return!0;return!1}_trackPointer(e){let n=this._pointerPositions[e.pointerId];n===void 0&&(n=new xe,this._pointerPositions[e.pointerId]=n),n.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const n=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[n]}_customWheelEvent(e){const n=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(n){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function xA(t){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(t.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(t)&&(this._addPointer(t),t.pointerType==="touch"?this._onTouchStart(t):this._onMouseDown(t)))}function SA(t){this.enabled!==!1&&(t.pointerType==="touch"?this._onTouchMove(t):this._onMouseMove(t))}function MA(t){switch(this._removePointer(t),this._pointers.length){case 0:this.domElement.releasePointerCapture(t.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(rv),this.state=lt.NONE;break;case 1:const e=this._pointers[0],n=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:n.x,pageY:n.y});break}}function EA(t){let e;switch(t.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Ds.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=lt.DOLLY;break;case Ds.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=lt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=lt.ROTATE}break;case Ds.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=lt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=lt.PAN}break;default:this.state=lt.NONE}this.state!==lt.NONE&&this.dispatchEvent(bf)}function wA(t){switch(this.state){case lt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(t);break;case lt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(t);break;case lt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(t);break}}function TA(t){this.enabled===!1||this.enableZoom===!1||this.state!==lt.NONE||(t.preventDefault(),this.dispatchEvent(bf),this._handleMouseWheel(this._customWheelEvent(t)),this.dispatchEvent(rv))}function AA(t){this.enabled===!1||this.enablePan===!1||this._handleKeyDown(t)}function bA(t){switch(this._trackPointer(t),this._pointers.length){case 1:switch(this.touches.ONE){case ws.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(t),this.state=lt.TOUCH_ROTATE;break;case ws.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(t),this.state=lt.TOUCH_PAN;break;default:this.state=lt.NONE}break;case 2:switch(this.touches.TWO){case ws.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(t),this.state=lt.TOUCH_DOLLY_PAN;break;case ws.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(t),this.state=lt.TOUCH_DOLLY_ROTATE;break;default:this.state=lt.NONE}break;default:this.state=lt.NONE}this.state!==lt.NONE&&this.dispatchEvent(bf)}function CA(t){switch(this._trackPointer(t),this.state){case lt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(t),this.update();break;case lt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(t),this.update();break;case lt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(t),this.update();break;case lt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(t),this.update();break;default:this.state=lt.NONE}}function RA(t){this.enabled!==!1&&t.preventDefault()}function PA(t){t.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function LA(t){t.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function DA(t,e){const n=new Ei;switch(t){case"solar_pv":{for(let r=0;r<3;r++){const s=new De(new dt(1.2,.05,.8),new We({color:1981023,metalness:.8,roughness:.2})),o=new De(new dt(1.18,.06,.78),new We({color:4886745,metalness:.5}));s.add(o),s.position.set(r*1.4-1.4,.8,0),s.rotation.x=-Math.PI*.2,n.add(s);const a=new De(new bn(.03,.03,.7,8),new We({color:8947848}));a.position.set(r*1.4-1.4,.35,.2),n.add(a)}break}case"smart_building":{const i=e.floors||5,r=i*.6,s=new De(new dt(2,r,1.5),new We({color:4871528}));s.position.y=r/2,n.add(s);for(let a=0;a<i;a++)for(let l=0;l<3;l++){const c=new De(new dt(.4,.3,.02),new We({color:8900331,emissive:2245802,emissiveIntensity:.3}));c.position.set(l*.6-.6,a*.6+.4,.76),n.add(c)}const o=new De(new dt(2.1,.1,1.6),new We({color:2963272}));o.position.y=r+.05,n.add(o);break}case"battery_storage":{const i=new De(new dt(1.2,1.5,.8),new We({color:2278750}));i.position.y=.75,n.add(i);for(let s=0;s<3;s++){const o=new De(new dt(.3,.2,.02),new We({color:1467700,emissive:65280,emissiveIntensity:.2}));o.position.set(0,.5+s*.35,.41),n.add(o)}const r=new De(new oc(.15,.4,4),new We({color:16498468}));r.position.set(0,1.3,.41),r.rotation.z=Math.PI,n.add(r);break}case"wind_turbine":{const i=new De(new bn(.15,.25,4,8),new We({color:16119285}));i.position.y=2,n.add(i);const r=new De(new dt(.6,.4,.4),new We({color:15066597}));r.position.set(0,4.1,0),n.add(r);const s=new De(new oc(.15,.3,16),new We({color:13421772}));s.position.set(0,4.1,.35),s.rotation.x=Math.PI/2,n.add(s);const o=new Ei;for(let a=0;a<3;a++){const l=new De(new dt(.15,1.8,.05),new We({color:16777215}));l.position.y=.9;const c=new Ei;c.add(l),c.rotation.z=a*Math.PI*2/3,o.add(c)}o.position.set(0,4.1,.5),o.userData.isRotating=!0,n.add(o);break}case"district_heating":{const i=new De(new dt(1.5,1,1),new We({color:14427686}));i.position.y=.5,n.add(i);const r=new De(new bn(.1,.1,1.2,16),new We({color:15680580}));r.rotation.z=Math.PI/2,r.position.set(0,.8,.6),n.add(r);const s=new De(new bn(.08,.08,1.2,16),new We({color:3900150}));s.rotation.z=Math.PI/2,s.position.set(0,.5,.6),n.add(s);const o=new De(new Bo(.2,.03,8,16,Math.PI),new We({color:16739179,emissive:16711680,emissiveIntensity:.5}));o.position.set(0,1.2,0),o.rotation.x=Math.PI/2,n.add(o);break}case"smart_grid":{const i=new De(new dt(1,.3,.8),new We({color:3621201}));i.position.y=.15,n.add(i);const r=new De(new dt(.6,.8,.5),new We({color:7041664}));r.position.y=.7,n.add(r);for(let s=0;s<3;s++){const o=new De(new bn(.05,.08,.4,8),new We({color:9133302}));o.position.set(s*.25-.25,1.3,0),n.add(o)}for(let s=0;s<3;s++){const o=new De(new bn(.01,.01,.8,8),new We({color:1118481}));o.rotation.z=Math.PI/2,o.position.set(.4,1.5,s*.15-.15),n.add(o)}break}case"ev_charger":{const i=new De(new dt(.3,1.4,.2),new We({color:1982639}));i.position.y=.7,n.add(i);const r=new De(new dt(.25,.2,.02),new We({color:0,emissive:65280,emissiveIntensity:.3}));r.position.set(0,1.1,.11),n.add(r);const s=new De(new Bo(.15,.02,8,16,Math.PI),new We({color:1118481}));s.position.set(.2,.5,.15),s.rotation.y=Math.PI/2,n.add(s);const o=new De(new dt(.8,.3,.4),new We({color:3900150,transparent:!0,opacity:.6}));o.position.set(.8,.15,0),n.add(o);break}case"heat_pump":{const i=new De(new dt(1.2,.9,.5),new We({color:16119285}));i.position.y=.45,n.add(i);const r=new De(new sc(.3,32),new We({color:3355443}));r.position.set(0,.5,.26),n.add(r);const s=new Ei;for(let a=0;a<4;a++){const l=new De(new dt(.25,.05,.02),new We({color:6710886}));l.rotation.z=a*Math.PI/2,s.add(l)}s.position.set(0,.5,.27),s.userData.isRotating=!0,n.add(s);const o=new De(new bn(.04,.04,.5,8),new We({color:15680580}));o.position.set(-.4,.7,-.3),n.add(o);break}case"chp_unit":{const i=new De(new dt(1.5,1.2,1),new We({color:16347926}));i.position.y=.6,n.add(i);const r=new De(new bn(.1,.12,.8,16),new We({color:6710886}));r.position.set(.5,1.6,0),n.add(r);const s=new De(new dt(.4,.3,.05),new We({color:2042167,emissive:2278750,emissiveIntensity:.2}));s.position.set(-.4,.8,.53),n.add(s);break}case"thermal_storage":{const i=new De(new bn(.6,.6,1.8,24),new We({color:15485081}));i.position.y=.9,n.add(i);for(let s=0;s<3;s++){const o=new De(new Bo(.62,.03,8,32),new We({color:12458077}));o.position.y=.4+s*.5,o.rotation.x=Math.PI/2,n.add(o)}const r=new De(new sc(.1,16),new We({color:16777215,emissive:16729156,emissiveIntensity:.5}));r.position.set(0,1.2,.61),n.add(r);break}case"load_center":{const i=new De(new dt(.8,1.2,.2),new We({color:4937059}));i.position.y=.6,n.add(i);for(let s=0;s<3;s++)for(let o=0;o<2;o++){const a=new De(new dt(.15,.2,.05),new We({color:1118481}));a.position.set(o*.25-.12,.3+s*.3,.12),n.add(a)}const r=new De(new Tf(.05,16,16),new We({color:2278750,emissive:65280,emissiveIntensity:.8}));r.position.set(.25,1,.12),n.add(r);break}}return n}function NA(t,e,n){const i=document.createElement("canvas"),r=i.getContext("2d");i.width=256,i.height=64,r.fillStyle="rgba(15, 23, 42, 0.85)",r.beginPath(),r.roundRect(4,4,i.width-8,i.height-8,8),r.fill(),r.font="bold 22px Arial",r.fillStyle="#e2e8f0",r.textAlign="center",r.textBaseline="middle",r.fillText(t.substring(0,20),i.width/2,i.height/2);const s=new KT(i),o=new K0({map:s,transparent:!0}),a=new XT(o);return a.position.copy(e),a.position.y=n+1.5,a.scale.set(2.5,.6,1),a}class IA{constructor(e,n,i,r=20){this.startPos=e.clone(),this.endPos=n.clone(),this.count=r,this.speed=.015,this.positions=new Float32Array(r*3),this.progress=new Float32Array(r);for(let a=0;a<r;a++)this.progress[a]=a/r,this.updateParticlePosition(a);const s=new Wt;s.setAttribute("position",new Un(this.positions,3));const o=new Q0({color:i,size:.2,transparent:!0,opacity:.9,blending:Cd});this.particles=new qT(s,o)}updateParticlePosition(e){const n=this.progress[e];this.positions[e*3]=this.startPos.x+(this.endPos.x-this.startPos.x)*n,this.positions[e*3+1]=this.startPos.y+(this.endPos.y-this.startPos.y)*n+Math.sin(n*Math.PI)*.4,this.positions[e*3+2]=this.startPos.z+(this.endPos.z-this.startPos.z)*n}update(){for(let e=0;e<this.count;e++)this.progress[e]+=this.speed,this.progress[e]>1&&(this.progress[e]=0),this.updateParticlePosition(e);this.particles.geometry.attributes.position.needsUpdate=!0}}function tg({config:t,animate:e=!0,onComponentMove:n}){const i=ae.useRef(null),r=ae.useRef(null),s=ae.useRef(null),o=ae.useRef(null),a=ae.useRef(null),l=ae.useRef(new Map),c=ae.useRef(null),d=ae.useRef(new Map),f=ae.useRef([]),h=ae.useRef([]),p=ae.useRef(0),g=ae.useRef(new mA),S=ae.useRef(new xe),m=ae.useRef(null),u=ae.useRef(new _i(new N(0,1,0),0));return ae.useEffect(()=>{if(!i.current)return;const _=i.current,v=new WT;v.background=new Ye(661032),r.current=v;const y=_.clientWidth||600,P=_.clientHeight||400,C=new Ln(50,y/P,.1,500);C.position.set(12,10,12),o.current=C;const b=new GT({antialias:!0});b.setSize(y,P),b.setPixelRatio(Math.min(window.devicePixelRatio,2)),b.shadowMap.enabled=!0,_.appendChild(b.domElement),s.current=b;const R=new yA(C,b.domElement);R.enableDamping=!0,R.dampingFactor=.08,a.current=R,v.add(new pA(16777215,.5));const T=new qm(16777215,1);T.position.set(10,20,10),T.castShadow=!0,v.add(T);const w=new qm(4491519,.3);w.position.set(-10,5,-10),v.add(w);const L=new De(new fa(60,60),new We({color:1712946,roughness:.9}));L.rotation.x=-Math.PI/2,L.receiveShadow=!0,v.add(L);const z=new gA(60,30,2767434,1714746);z.position.y=.01,v.add(z);const F=new Ei;v.add(F),c.current=F;const j=()=>{p.current=requestAnimationFrame(j),R.update(),e&&(f.current.forEach(U=>U.update()),h.current.forEach(U=>{U.rotation.z+=.02})),b.render(v,C)};j();const Z=()=>{const U=_.clientWidth,te=_.clientHeight;C.aspect=U/te,C.updateProjectionMatrix(),b.setSize(U,te)};window.addEventListener("resize",Z);const X=U=>{const te=b.domElement.getBoundingClientRect();S.current.x=(U.clientX-te.left)/te.width*2-1,S.current.y=-((U.clientY-te.top)/te.height)*2+1},ee=U=>{if(!n)return;X(U),g.current.setFromCamera(S.current,C);const te=Array.from(l.current.entries());for(const[ue,we]of te)if(g.current.intersectObject(we,!0).length>0){R.enabled=!1;const ie=new N;g.current.ray.intersectPlane(u.current,ie),m.current={id:ue,model:we,offset:we.position.clone().sub(ie)},b.domElement.style.cursor="grabbing";break}},D=U=>{if(!m.current){if(n){X(U),g.current.setFromCamera(S.current,C);let Y=!1;for(const ie of l.current.values())if(g.current.intersectObject(ie,!0).length>0){Y=!0;break}b.domElement.style.cursor=Y?"grab":"default"}return}X(U),g.current.setFromCamera(S.current,C);const te=new N;g.current.ray.intersectPlane(u.current,te);const ue=te.add(m.current.offset);m.current.model.position.x=ue.x,m.current.model.position.z=ue.z;const we=d.current.get(m.current.id);we&&(we.position.x=ue.x,we.position.z=ue.z)},K=()=>{if(m.current&&n){const{id:U,model:te}=m.current,ue=.035,we=-300*ue,Y=-200*ue,ie=(te.position.x-we)/ue,he=(te.position.z-Y)/ue;n(U,ie,he)}m.current=null,R.enabled=!0,b.domElement.style.cursor="default"};return b.domElement.addEventListener("pointerdown",ee),b.domElement.addEventListener("pointermove",D),b.domElement.addEventListener("pointerup",K),b.domElement.addEventListener("pointerleave",K),()=>{window.removeEventListener("resize",Z),b.domElement.removeEventListener("pointerdown",ee),b.domElement.removeEventListener("pointermove",D),b.domElement.removeEventListener("pointerup",K),b.domElement.removeEventListener("pointerleave",K),cancelAnimationFrame(p.current),b.dispose(),_.removeChild(b.domElement)}},[e,n]),ae.useEffect(()=>{var T,w,L;const _=r.current,v=c.current;if(!_||!v)return;for(l.current.forEach(z=>_.remove(z)),l.current.clear();v.children.length;)v.remove(v.children[0]);if(f.current.forEach(z=>_.remove(z.particles)),f.current=[],h.current=[],!t)return;const y=.035,P=-300*y,C=-200*y;t.components.forEach(z=>{const F=DA(z.type,z.params),j=z.x*y+P,Z=z.y*y+C;F.position.set(j,0,Z),_.add(F),l.current.set(z.id,F),F.traverse(K=>{K.userData.isRotating&&h.current.push(K)});const ee=new Br().setFromObject(F).max.y,D=NA(z.name,new N(j,0,Z),ee);v.add(D)});const b=new Set(["solar_pv","wind_turbine","chp_unit"]),R=new Set(["smart_building","ev_charger","load_center","heat_pump"]);if(t.connections.forEach(z=>{const F=t.components.find(se=>se.id===z.from),j=t.components.find(se=>se.id===z.to),Z=l.current.get(z.from),X=l.current.get(z.to);if(!Z||!X||!F||!j)return;let ee=Z.position.clone(),D=X.position.clone();const K=b.has(F.type),U=b.has(j.type),te=R.has(F.type),ue=R.has(j.type);(te&&!ue||U&&!K)&&([ee,D]=[D,ee]),ee.y=.5,D.y=.5;const we=z.type==="heat"?15680580:z.type==="both"?11032055:3900150,Y=new tv(Z.position.clone().setY(.5),X.position.clone().setY(.5)),ie=new De(new Af(Y,8,.04,8,!1),new We({color:we,transparent:!0,opacity:.4}));_.add(ie);const he=new IA(ee,D,we,18);_.add(he.particles),f.current.push(he)}),t.components.length>0){const z=new Br;l.current.forEach(X=>z.expandByObject(X));const F=new N,j=new N;z.getCenter(F),z.getSize(j),(T=a.current)==null||T.target.copy(F);const Z=Math.max(j.x,j.z)*2;(w=o.current)==null||w.position.set(F.x+Z,Z*.7,F.z+Z),(L=a.current)==null||L.update()}},[t]),M.jsx("div",{ref:i,style:{width:"100%",height:"100%",minHeight:300}})}function sv(t){return t.endsWith("/")?t:t+"/"}const ds=(t,e)=>{const n=t.replace(/^\/+/,"");return new URL(n,sv(e)).toString()},UA=(t,e)=>{const n=t.replace(/^\/+/,""),i=new URL(n,sv(e));return i.protocol=i.protocol.startsWith("https")?"wss:":"ws:",i.toString()};function ng(t){return t==null?"—":new Intl.NumberFormat(void 0,{notation:"compact",maximumFractionDigits:2}).format(t)}function FA(t){return t==null?"—":t.toLocaleString(void 0,{maximumFractionDigits:2})}function OA(){var Ue,Ge,O;const t=ae.useMemo(()=>window.location.origin,[]),[e,n]=ae.useState([]),[i,r]=ae.useState(!1),[s,o]=ae.useState(null),[a,l]=ae.useState(null),[c,d]=ae.useState(null),[f,h]=ae.useState(null),[p,g]=ae.useState([]),[S,m]=ae.useState("idle"),[u,_]=ae.useState("runs"),[v,y]=ae.useState("3d"),[P,C]=ae.useState("2d"),[b,R]=ae.useState(null),[T,w]=ae.useState(!1),[L,z]=ae.useState(12),[F,j]=ae.useState(800),[Z,X]=ae.useState(.5),[ee,D]=ae.useState(!1);ae.useState(null)[0];const[K,U]=ae.useState(.58),[te,ue]=ae.useState(!1),[we,Y]=ae.useState(320),[ie,he]=ae.useState(!1),[se,Le]=ae.useState(!1),[Ne,Be]=ae.useState(!1),Xe=ae.useCallback(W=>{g(G=>[...G,`${new Date().toLocaleTimeString()} ${W}`].slice(-50))},[]),Oe=ae.useCallback(async()=>{r(!0);try{const W=await fetch(ds("/runs",t));if(!W.ok)throw new Error(`Failed to load runs (${W.status})`);const G=await W.json();if(n(G),G.length===0){o(E=>E!==null?null:E);return}o(E=>!(E?G.some(I=>I.id===E):!1)&&G.length>0?G[0].id:E)}catch(W){console.error(W),Xe(`Error loading runs: ${W.message}`)}finally{r(!1)}},[t,Xe]);ae.useEffect(()=>{Oe();const W=setInterval(Oe,15e3);return()=>clearInterval(W)},[Oe]),ae.useEffect(()=>{if(!s){h(null),l(null),d(null);return}const W=new AbortController;return(async()=>{try{const E=await fetch(ds(`/runs/${s}/state`,t),{signal:W.signal});if(!E.ok)throw new Error(`Failed to load state (${E.status})`);const x=await E.json();h(x)}catch(E){E.name!=="AbortError"&&Xe(`Error fetching state: ${E.message}`)}})(),()=>W.abort()},[t,Xe,s]),ae.useEffect(()=>{const W=new AbortController;return(async()=>{if(s)try{const E=await fetch(ds(`/runs/${s}`,t),{signal:W.signal});if(!E.ok)return;const x=await E.json();if(l(x),x.scenario_id){const I=await fetch(ds(`/scenarios/${x.scenario_id}`,t),{signal:W.signal});I.ok?d(await I.json()):d(null)}else d(null)}catch{}})(),()=>W.abort()},[t,s]),ae.useEffect(()=>{if(!s)return;const W=UA(`/runs/${s}/ws`,t);m("connecting"),Xe(`Connecting to ${W}`);const G=new WebSocket(W);return G.onopen=()=>{m("open"),Xe("WebSocket connected"),G.send(JSON.stringify({command:"state"}))},G.onclose=E=>{m("closed"),Xe(`WebSocket closed (code ${E.code})`)},G.onerror=E=>{console.error("WebSocket error",E),Xe("WebSocket error encountered")},G.onmessage=E=>{try{const x=JSON.parse(E.data);x.type==="state"?h(x.payload):x.type==="error"&&Xe(`Backend error: ${x.message}`)}catch(x){console.error("Malformed message",x)}},()=>{G.close()}},[Xe,s,t]);const pt=W=>{o(W)},B=async W=>{if(s)try{const G=await fetch(ds(`/runs/${s}/step`,t),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({steps:W})});if(!G.ok)throw new Error(`Step failed (${G.status})`);const E=await G.json();h(E),Xe(`Advanced simulation by ${W} step(s)`)}catch(G){Xe(`Error stepping simulation: ${G.message}`)}};ae.useEffect(()=>{if(!T||!s||u!=="runs"||(a==null?void 0:a.status)!=="running")return;let W=!1,G;const E=async()=>{W||(await B(L),G=window.setTimeout(E,Math.max(100,F)))};return G=window.setTimeout(E,0),()=>{W=!0,G&&window.clearTimeout(G)}},[T,L,F,s,u,a==null?void 0:a.status]);const Rt=(Ue=f==null?void 0:f.metrics)!=null?Ue:{};return ae.useEffect(()=>{const W=E=>{if(!ee)return;const x=document.querySelector(".split-container");if(!x)return;const I=x.getBoundingClientRect(),Q=E.clientX-I.left,re=Math.max(.2,Math.min(.8,Q/I.width));X(re)},G=()=>D(!1);return window.addEventListener("mousemove",W),window.addEventListener("mouseup",G),()=>{window.removeEventListener("mousemove",W),window.removeEventListener("mouseup",G)}},[ee]),ae.useEffect(()=>{const W=E=>{if(!te)return;const x=document.querySelector(".vsplit-container");if(!x)return;const I=x.getBoundingClientRect(),Q=E.clientY-I.top,re=Math.max(.25,Math.min(.85,Q/I.height));U(re)},G=()=>ue(!1);return window.addEventListener("mousemove",W),window.addEventListener("mouseup",G),()=>{window.removeEventListener("mousemove",W),window.removeEventListener("mouseup",G)}},[te]),ae.useEffect(()=>{const W=E=>{if(!ie)return;const x=document.querySelector(".app-shell");if(!x)return;const I=x.getBoundingClientRect(),Q=E.clientX-I.left,re=220,ne=Math.max(360,I.width*.5);Y(Math.max(re,Math.min(ne,Q)))},G=()=>he(!1);return window.addEventListener("mousemove",W),window.addEventListener("mouseup",G),()=>{window.removeEventListener("mousemove",W),window.removeEventListener("mouseup",G)}},[ie]),M.jsxs("div",{className:"app-shell",style:{"--sidebar-width":`${we}px`},children:[u==="runs"?M.jsxs(M.Fragment,{children:[M.jsx(Fx,{runs:e,selectedId:s,onSelect:pt,onRefresh:Oe,onDelete:async W=>{var G;try{const E=ds(`/runs/${W}`,t),x=await fetch(E,{method:"DELETE"});if(!x.ok)throw new Error(`Delete failed (${x.status})`);s===W&&o(null),await Oe()}catch(E){Xe(`Delete run error: ${(G=E==null?void 0:E.message)!=null?G:String(E)}`)}},isLoading:i}),M.jsx("div",{className:"sidebar-divider",onMouseDown:()=>he(!0),title:"Resize sidebar"}),M.jsxs("main",{className:"main-content",children:[M.jsxs("div",{className:"header",children:[M.jsxs("div",{children:[M.jsx("h1",{children:"Digital Twin Console"}),M.jsxs("p",{style:{color:"#64748b"},children:["WebSocket status: ",S]})]}),M.jsxs("div",{style:{display:"flex",gap:"0.5rem",alignItems:"center",flexWrap:"wrap"},children:[M.jsx("button",{className:"button",onClick:()=>_("builder"),children:"🏗️ Digital Twin"}),M.jsx("button",{className:"button button-secondary",onClick:()=>_("scenarios"),children:"Scenarios"}),M.jsx("span",{style:{width:1,height:24,background:"#475569",margin:"0 0.25rem"}}),M.jsx("button",{className:"button",onClick:()=>y("3d"),style:{background:v==="3d"?"#2563eb":"#475569"},children:"3D"}),M.jsx("button",{className:"button",onClick:()=>y("charts"),style:{background:v==="charts"?"#2563eb":"#475569"},children:"Charts"}),M.jsx("span",{style:{width:1,height:24,background:"#475569",margin:"0 0.25rem"}}),M.jsx("button",{className:"button",onClick:()=>B(1),disabled:!s||(a==null?void 0:a.status)!=="running",children:"Step"}),M.jsx("button",{className:"button",onClick:()=>B(12),disabled:!s||(a==null?void 0:a.status)!=="running",children:"×12"}),M.jsx("button",{className:"button",onClick:()=>w(W=>!W),disabled:!s||(a==null?void 0:a.status)!=="running",style:{background:T?"#dc2626":"#2563eb"},children:T?"⏸ Pause":"▶ Auto"}),M.jsx("input",{type:"number",value:L,min:1,max:288,onChange:W=>z(Math.max(1,Math.min(288,Number(W.target.value)))),style:{width:50},title:"Steps per interval"}),M.jsx("input",{type:"number",value:F,min:100,step:100,onChange:W=>j(Math.max(100,Number(W.target.value))),style:{width:60},title:"Interval (ms)"}),M.jsxs("label",{style:{display:"inline-flex",alignItems:"center",gap:4,fontSize:"0.8rem",color:"#94a3b8"},children:[M.jsx("input",{type:"checkbox",checked:Ne,onChange:W=>Be(W.target.checked)})," Reduce motion"]}),M.jsx("button",{className:"button button-secondary",onClick:()=>Le(W=>!W),style:{padding:"0.35rem 0.5rem"},children:se?"▼":"▲"})]})]}),M.jsxs("section",{className:"metrics-grid",children:[M.jsxs("article",{className:"metric-card",children:[M.jsx("div",{className:"metric-label",children:"Timestep"}),M.jsx("div",{className:"metric-value",children:(Ge=Rt.timestep)!=null?Ge:"—"})]}),M.jsxs("article",{className:"metric-card",children:[M.jsx("div",{className:"metric-label",children:"Fund NAV (DKK)"}),M.jsx("div",{className:"metric-value",children:ng(Rt.fund_nav)})]}),M.jsxs("article",{className:"metric-card",children:[M.jsx("div",{className:"metric-label",children:"Trading Budget (DKK)"}),M.jsx("div",{className:"metric-value",children:ng(Rt.budget)})]}),M.jsxs("article",{className:"metric-card",children:[M.jsx("div",{className:"metric-label",children:"Last Revenue"}),M.jsx("div",{className:"metric-value",children:FA(Rt.last_revenue)})]})]}),M.jsxs("section",{className:"vsplit-container",style:{height:"100%"},children:[M.jsx("div",{className:"vsplit-pane",style:{flexBasis:se?"100%":`${Math.round(K*100)}%`,flexGrow:1,minHeight:0,padding:v==="3d"?0:"1rem",display:"flex",flexDirection:"column"},children:v==="3d"?M.jsxs("div",{className:"viewer-panel",style:{minHeight:320,height:"100%",position:"relative"},children:[M.jsx("div",{style:{position:"absolute",top:8,right:8,zIndex:20,display:"flex",gap:8,alignItems:"center",background:"rgba(15,23,42,0.65)",padding:"6px 8px",borderRadius:6,border:"1px solid rgba(148,163,184,0.2)"},children:M.jsx("button",{className:"button",onClick:()=>_("builder"),style:{fontSize:11,padding:"4px 8px"},children:"🏗️ Edit Digital Twin"})}),M.jsx(tg,{config:b,animate:!Ne}),!b&&M.jsxs("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",textAlign:"center",color:"#64748b"},children:[M.jsx("div",{style:{fontSize:48,marginBottom:12},children:"🏗️"}),M.jsx("div",{children:"No digital twin configured"}),M.jsx("button",{className:"button",onClick:()=>_("builder"),style:{marginTop:12},children:"Create Digital Twin"})]})]}):M.jsx("div",{className:"metrics-grid",style:{height:"100%",overflow:"auto"},children:M.jsx(Ox,{apiBase:t,runId:s})})}),!se&&M.jsx("div",{className:"vsplit-divider",onMouseDown:()=>ue(!0),onDoubleClick:()=>U(.58)}),!se&&M.jsxs("div",{className:"split-container",style:{flexBasis:`${Math.round((1-K)*100)}%`,minHeight:180},children:[M.jsxs("div",{className:"split-pane",style:{flexBasis:`${Math.round(Z*100)}%`,padding:"1rem",minHeight:220,display:"flex",flexDirection:"column",overflow:"auto"},children:[M.jsx("div",{className:"metric-label",children:"Scenario"}),c?M.jsxs("div",{children:[M.jsx("h3",{style:{margin:"0.25rem 0 0.5rem 0"},children:c.name}),M.jsx("p",{style:{color:"#94a3b8"},children:(O=c.description)!=null?O:"—"}),M.jsx("div",{style:{marginTop:"0.5rem",fontSize:"0.95rem",whiteSpace:"pre-wrap"},children:c.details&&M.jsx("p",{style:{marginTop:0},children:c.details})}),M.jsxs("div",{style:{marginTop:"0.5rem",fontSize:"0.9rem"},children:[M.jsx("div",{style:{color:"#94a3b8",marginBottom:4},children:"Overrides"}),M.jsx("ul",{style:{margin:0,paddingLeft:"1.25rem"},children:Object.entries(c.config_overrides||{}).map(([W,G])=>M.jsxs("li",{children:[M.jsx("code",{children:W}),": ",M.jsx("span",{children:String(G)})]},W))})]})]}):M.jsx("div",{children:"—"})]}),M.jsx("div",{className:"split-divider",onMouseDown:()=>D(!0),onDoubleClick:()=>X(.5)}),M.jsx("div",{className:"split-pane",style:{flexBasis:`${Math.round((1-Z)*100)}%`,padding:0,minHeight:220,display:"flex",flexDirection:"column"},children:M.jsx("div",{className:"log-panel",style:{height:"100%",maxHeight:"100%",flex:1},children:p.map((W,G)=>M.jsx("div",{children:W},G))})})]})]})]})]}):M.jsxs("main",{className:"main-content",style:{gridColumn:"1 / -1"},children:[M.jsxs("div",{className:"header",children:[M.jsx("h1",{children:"Scenarios"}),M.jsx("div",{style:{display:"flex",gap:"0.5rem"},children:M.jsx("button",{className:"button",onClick:()=>_("runs"),children:"Back to Runs"})})]}),M.jsx(zx,{apiBase:t,onRun:W=>{_("runs"),o(W),Oe()}})]}),u==="builder"&&M.jsxs("main",{className:"main-content",style:{gridColumn:"1 / -1",display:"flex",flexDirection:"column",height:"100vh",overflow:"hidden"},children:[M.jsxs("div",{className:"header",style:{flexShrink:0},children:[M.jsxs("div",{children:[M.jsx("h1",{children:"🏗️ Digital Twin Builder"}),M.jsx("p",{style:{color:"#64748b",margin:0},children:"Drag and drop components to design your PED system"})]}),M.jsxs("div",{style:{display:"flex",gap:"0.5rem",alignItems:"center"},children:[M.jsx("button",{className:"button",onClick:()=>C("2d"),disabled:P==="2d",children:"2D Editor"}),M.jsx("button",{className:"button",onClick:()=>C("3d"),disabled:P==="3d",children:"3D Preview"}),M.jsx("button",{className:"button",onClick:()=>_("scenarios"),children:"Scenarios"}),M.jsx("button",{className:"button",onClick:()=>_("runs"),children:"Back to Runs"})]})]}),M.jsx("div",{style:{flex:1,minHeight:0,overflow:"hidden"},children:P==="2d"?M.jsx(Hx,{onConfigChange:R,initialConfig:b,apiBase:t,onRunSimulation:W=>{o(W),_("runs"),Oe()}}):M.jsx(tg,{config:b,animate:!Ne})})]})]})}class kA extends mg.Component{constructor(e){super(e),this.state={hasError:!1}}static getDerivedStateFromError(e){var n;return{hasError:!0,message:(n=e==null?void 0:e.message)!=null?n:String(e)}}componentDidCatch(e,n){console.error("[UI ErrorBoundary]",e,n)}render(){return this.state.hasError?M.jsxs("div",{style:{padding:"1rem",color:"#fca5a5"},children:[M.jsx("h2",{children:"Something went wrong rendering the UI."}),M.jsx("pre",{style:{whiteSpace:"pre-wrap"},children:this.state.message})]}):this.props.children}}function Cf(t,e){try{const n="__boot_error_overlay__";let i=document.getElementById(n);i||(i=document.createElement("div"),i.id=n,i.setAttribute("role","alert"),i.style.position="fixed",i.style.inset="0",i.style.zIndex="9999",i.style.background="rgba(15,23,42,0.96)",i.style.color="#fca5a5",i.style.fontFamily="system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial",i.style.padding="24px",document.body.appendChild(i));const r=typeof e=="string"?e:e instanceof Error?e.stack||e.message:JSON.stringify(e);i.innerHTML=`<h2 style="margin:0 0 8px 0; color:#fecaca">${t}</h2><pre style="white-space:pre-wrap; font-size:14px; color:#fca5a5">${r!=null?r:""}</pre>`}catch{}}window.addEventListener("error",t=>{Cf("Runtime error",(t==null?void 0:t.error)||(t==null?void 0:t.message))});window.addEventListener("unhandledrejection",t=>{Cf("Unhandled promise rejection",t==null?void 0:t.reason)});var ig,rg;try{let t=document.getElementById("root");t||(t=document.createElement("div"),t.id="root",document.body.appendChild(t)),console.log("[UI] Mounting app. API base =",(rg=(ig=import.meta)==null?void 0:ig.env)==null?void 0:rg.VITE_API_BASE),Uu.createRoot(t).render(M.jsx(mg.StrictMode,{children:M.jsx(kA,{children:M.jsx(OA,{})})}))}catch(t){console.error("[UI] Failed to mount app",t),Cf("Failed to mount app",t)}
//# sourceMappingURL=index-DADmN8nI.js.map
